...
#define getAss(o,k) objc_getAssociatedObject(o,k)
#define setAss(o,k,v,p) objc_setAssociatedObject(o,k,v,p)
#define M0(t,s) ((id(*)(id,SEL))objc_msgSend)(t,s)
#define M1(t,s,a) ((id(*)(id,SEL,id))objc_msgSend)(t,s,a)
#define M2(t,s,a,b) ((id(*)(id,SEL,id,id))objc_msgSend)(t,s,a,b)
#define B1(t,s,a) ((BOOL(*)(id,SEL,BOOL))objc_msgSend)(t,s,a)
#define F1(t,s,a) ((float(*)(id,SEL,id))objc_msgSend)(t,s,a)
#define C(n) NSClassFromString(n)
#define S(n) NSSelectorFromString(n)
#define W UIScreen.mainScreen.bounds
static CFStringRef kPrefsDomain = CFSTR("com.futur3sn0w.ccaster.preferences");
...
static const CGFloat kRestingModuleOffset = -8.0;
static const CGFloat kEditingModuleOffset = -48.0;
static const NSUInteger kMinimumGridRows = 8;
static CGFloat kGridCellSize = 67.0;
static CGFloat kGridGap = 12.0;
static const CGFloat kGridCellScale = 67.0 / 69.0;
static const CGFloat kGridGapScale = 12.0 / 15.0;
#define kCCAGridStep (kCCAGridCellSize + kCCAGridGap)
#define kCCAPageSpan (kCCAMinimumGridRows * kCCAGridStep)
static const CGFloat kPageIndicatorRestStep = 39.0;
static const CGFloat kPageIndicatorScrubStep = 58.0;
static const CGFloat kPageIndicatorRestHostWidth = 42.0;
static const CGFloat kPageIndicatorScrubHostWidth = 58.0;
static const CGFloat kPageIndicatorRestRightInset = -3.0;
static const CGFloat kPageIndicatorScrubRightInset = -3.0;
static const CGFloat kPageIndicatorMaxSlideOut = 24.0;
static const CGFloat kPagerViscosityResponse = 9.0;
static const CGFloat kPagerJelloVelocityResponse = 11.0;
static const CGFloat kPagerJelloVelocityToScale = 0.0030;
static const CGFloat kPagerJelloTensionToScale = 0.022;
static const CGFloat kPagerMaximumJelloScale = 0.025;
static const CGFloat kEditScrubModuleWrapperCenteringX = 81.0;
static const CGFloat kEditScrubModuleWrapperCenteringY = 118.0;
static const NSUInteger kMaxPages = 9;
static NSHashTable*gOverlayControllers;
...
static NSArray*gCCAExpansionHiddenLiveViews = nil;
static NSArray*gCCAExpansionHiddenLiveAlphas = nil;
static NSArray*gCCAExpansionHiddenLiveLayerOpacities = nil;
...
static NSUInteger gCCAConnectivityDetachedOriginalIndex = NSIntegerMax;
...
static const NSInteger kEditShieldTag = 181017;
static const NSInteger kRemoveButtonTag = 181018;
static const NSInteger kPowerMaterialTag = 181019;
static const NSInteger kEditGridTag = 181020;
static const NSInteger kEditTouchShieldTag = 181021;
static const NSInteger kResizeButtonTag = 181022;
static const NSInteger kResizePresentationTag = 181023;
static const CGFloat kRemoveTapCornerRadius = 30.0;
static const NSInteger kResizeMaterialTag = 181024;
static const NSInteger kResizeBlurSnapshotTag = 181025;
static const NSInteger kResizePresentationGlyphTag = 181036;
static const NSInteger kExtendedHitBridgeTag = 181026;
static const NSInteger kAddControlButtonTag = 181027;
static const NSInteger kSliderColorGlyphTag = 181028;
static const NSInteger kSliderOutgoingGlyphTag = 181029;
static const NSInteger kPageIndicatorHostTag = 181030;
static const NSInteger kTopFadeTag = 181031;
static const NSInteger kConnectivityMiniClusterTag = 181032;
static const NSInteger kConnectivityExpandButtonTag = 181033;
static const NSInteger kConnectivityCompactAirDropTag = 181034;
static const NSInteger kConnectivityCompactBluetoothTag = 181035;
static const NSInteger kQuickAccessDismissalProxyTag = 181039;
static const NSInteger kConnectivityTileActionProxyTag = 181049;
static const NSInteger kConnectivitySelectedSurfaceTag = 181050;
static const NSInteger kConnectivityBluetoothPackageGlyphTag = 181051;
static const NSInteger kOwnedDuplicateHostTag = 181052;
static const NSInteger kConnectivityExpandedCardBaseTag = 181040;
static const NSInteger kConnectivityExpandedVPNTag = 181048;
static const CGFloat kRemoveHitSize = 44.0;
static const CGFloat kRemoveVisualCenterOffset = 8.0;
static void*kOwnGesture=&kOwnGesture;
static void*kConnectivityForwardControl=&kConnectivityForwardControl;
static void*kConnectivityIdentifier=&kConnectivityIdentifier;
static void*kConnectivitySelectedState=&kConnectivitySelectedState;
static void*kConnectivitySuppressedSurface=&kConnectivitySuppressedSurface;
static void*kConnectivityProxyPrepared=&kConnectivityProxyPrepared;
static void*kConnectivityProxyRefreshScheduled=&kConnectivityProxyRefreshScheduled;
static void*kConnectivityExpandedCard=&kConnectivityExpandedCard;
static void*kConnectivityExpandedSurface=&kConnectivityExpandedSurface;
static void*kConnectivityExpandedGridGlyph=&kConnectivityExpandedGridGlyph;
static void*kConnectivityForceFired=&kConnectivityForceFired;
static void*kDisabledGestures=&kDisabledGestures;
static void*kOriginalCornerRadius=&kOriginalCornerRadius;
static void*kOriginalMasksToBounds=&kOriginalMasksToBounds;
static void*kOriginalTransform=&kOriginalTransform;
static void*kOriginalSublayerTransform=&kOriginalSublayerTransform;
static void*kOriginalAlpha=&kOriginalAlpha;
static void*kEditScrubWrapperBaseTransform=&kEditScrubWrapperBaseTransform;
static void*kScrubCollectionBounds=&kScrubCollectionBounds;
static void*kScrubCollectionPosition=&kScrubCollectionPosition;
static void*kDragStartFrame=&kDragStartFrame;
static void*kDragStartPoint=&kDragStartPoint;
static void*kEditGrid=&kEditGrid;
static void*kEditPageGrids=&kEditPageGrids;
static void*kEditGridStack=&kEditGridStack;
static void*kEditGridBaseOrigin=&kEditGridBaseOrigin;
static void*kRemoveButton=&kRemoveButton;
static void*kRemoveModuleView=&kRemoveModuleView;
static void*kDragPreviewTarget=&kDragPreviewTarget;
static void*kDragProxy=&kDragProxy;
static void*kDragBaseOrder=&kDragBaseOrder;
static void*kDragPreviewTargetID=&kDragPreviewTargetID;
static void*kDragProxyStartFrame=&kDragProxyStartFrame;
static void*kDragBaseFrames=&kDragBaseFrames;
static void*kDragPendingTargetID=&kDragPendingTargetID;
static void*kDragPreviewLocked=&kDragPreviewLocked;
static void*kDragGrabOffset=&kDragGrabOffset;
static void*kDragMoved=&kDragMoved;
static void*kDragLandingOrigin=&kDragLandingOrigin;
static void*kDragStartPage=&kDragStartPage;
static void*kDragEdgeDwell=&kDragEdgeDwell;
static void*kDragEdgeDwellDirection=&kDragEdgeDwellDirection;
static void*kSmallModuleChrome=&kSmallModuleChrome;
static void*kDragHiddenChrome=&kDragHiddenChrome;
static void*kResizeButton=&kResizeButton;
static void*kOwnedDuplicateContainer=&kOwnedDuplicateContainer;
static void*kOwnedDuplicatePresentation=&kOwnedDuplicatePresentation;
static void*kResizeStartSize=&kResizeStartSize;
static void*kResizeCandidateSize=&kResizeCandidateSize;
static void*kResizePreview=&kResizePreview;
static void*kResizePreviewStartFrame=&kResizePreviewStartFrame;
static void*kResizePresentationTransition=&kResizePresentationTransition;
static void*kResizePresentationLayout=&kResizePresentationLayout;
static void*kResizePresentationSizeOverride=&kResizePresentationSizeOverride;
static void*kResizeGlyphHandoffView=&kResizeGlyphHandoffView;
static void*kResizeGlyphHandoffHosts=&kResizeGlyphHandoffHosts;
static void*kResizeSuppressedGestures=&kResizeSuppressedGestures;
static void*kQuickAccessAnimationToken=&kQuickAccessAnimationToken;
static void*kAddSheetModule=&kAddSheetModule;
static void*kAddSheetController=&kAddSheetController;
static void*kAddSheetContext=&kAddSheetContext;
static void*kSliderGlyphColored=&kSliderGlyphColored;
static void*kSliderGlyphOriginalImage=&kSliderGlyphOriginalImage;
static void*kSliderGlyphOriginalTint=&kSliderGlyphOriginalTint;
static void*kSliderGlyphOriginalAlpha=&kSliderGlyphOriginalAlpha;
static void*kSliderGlyphOriginalHidden=&kSliderGlyphOriginalHidden;
static void*kSliderGlyphSymbolState=&kSliderGlyphSymbolState;
static void*kSliderOverscrollBaseTransform=&kSliderOverscrollBaseTransform;
static void*kSliderOverscrollStartValue=&kSliderOverscrollStartValue;
static void*kSliderOverscrollAmount=&kSliderOverscrollAmount;
static void*kSliderOverscrollTarget=&kSliderOverscrollTarget;
static void*kNowPlayingLayoutMode=&kNowPlayingLayoutMode;
static void*kMediaRouteGlyphShrink=&kMediaRouteGlyphShrink;
static void*kPagerGesture=&kPagerGesture;
static void*kPagerModulePanDependency=&kPagerModulePanDependency;
static void*kEditDismissPan=&kEditDismissPan;
static void*kPageIndicatorPan=&kPageIndicatorPan;
static void*kPageIndicatorCount=&kPageIndicatorCount;
static void*kPageIndicatorDragging=&kPageIndicatorDragging;
static void*kPagerStartPage=&kPagerStartPage;
static void*kPagerSuppressedGestures=&kPagerSuppressedGestures;
static void*kPagerNativeScrollView=&kPagerNativeScrollView;
static void*kPagerNativeOffset=&kPagerNativeOffset;
static void*kNativeScrollBaseSublayerTransform=&kNativeScrollBaseSublayerTransform;
static void*kNativeScrollOpeningCompensation=&kNativeScrollOpeningCompensation;
static void*kNativeScrollBaseline=&kNativeScrollBaseline;
static void*kNativeScrollBoundsOriginBaseline=&kNativeScrollBoundsOriginBaseline;
static void*kNativeScrollContentInsetBaseline=&kNativeScrollContentInsetBaseline;
static void*kPageHidden=&kPageHidden;
static void*kPageAnimationToken=&kPageAnimationToken;
static void*kPagerVisualLayerTransform=&kPagerVisualLayerTransform;
static void*kPagerVisualLayerOpacity=&kPagerVisualLayerOpacity;
static void*kPagerVisualLayerFilters=&kPagerVisualLayerFilters;
static void*kPagerVisualBlurFilter=&kPagerVisualBlurFilter;
static void*kExpansionPageGeometrySync=&kExpansionPageGeometrySync;
static void*kExpansionCollectionLayerPosition=&kExpansionCollectionLayerPosition;
static void*kExpansionGeometryHoldToken=&kExpansionGeometryHoldToken;
...
static NSArray*gCCAProviderOrder;
static NSDictionary*gCCAProviderSizes;
...
static NSUInteger gCCAPendingPageAfterRebuild = NSIntegerMax;
static BOOL CCAModuleViewIsPageHidden(UIView *view) {
return [getAss(view,kCCAPageHiddenKey) boolValue];
}
...
if (containerWidth < 1.0) containerWidth = UIScreen.mainScreen.bounds.size.width;
CGFloat nativeBase = frame.origin.x - (CGFloat)layoutRect.origin.x * kCCAGridStep;
CGFloat nativeFootprint = nativeBase * 2.0 + CCAGridVisibleWidth();
return (0.0>containerWidth - nativeFootprint?0.0:containerWidth - nativeFootprint) * 0.5;
}
...
(gCCAPagerInteractiveTranslation<0?-(gCCAPagerInteractiveTranslation):gCCAPagerInteractiveTranslation) > 0.01;
}
...
(nativeCell - kCCAGridCellSize<0?-(nativeCell - kCCAGridCellSize):nativeCell - kCCAGridCellSize) < 0.5 &&
(nativeGap - kCCAGridGap<0?-(nativeGap - kCCAGridGap):nativeGap - kCCAGridGap) < 0.5;
if (!alreadyCompact) {
...
static NSArray*CCACollectModuleControllers(UIViewController *root);
...
[getAss(gesture,kCCAOwnGestureKey) boolValue] ||
...
BOOL plausiblePull = location.x >= root.bounds.size.width * 0.45 &&
location.y <= root.bounds.size.height * 0.72 && velocity.y > -40.0;
if (!plausiblePull) continue;
NSString *name = [pan.class className];
...
NSValue *baseline = getAss(overlay,kCCANativeScrollBaselineKey);
...
setAss(overlay,kCCANativeScrollBaselineKey, baseline, 1);
setAss(overlay,kCCANativeScrollBoundsOriginBaselineKey, [NSValue valueWithCGPoint:scrollView.bounds.origin], 1);
setAss(overlay,kCCANativeScrollContentInsetBaselineKey, [NSValue valueWithUIEdgeInsets:scrollView.contentInset], 1);
return baseline;
}
static BOOL CCAViewTreeContainsClassName(UIView *root, NSString *className) {
if (!root || !className.length) return 0;
if ([[root.class className] isEqualToString:className]) return 1;
NSMutableArray*queue = [NSMutableArray arrayWithObject:root];
NSUInteger depth = 0;
while (queue.count && depth < 80) {
@autoreleasepool{
UIView *view = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([[view.class className] isEqualToString:className]) return 1;
[queue addObjectsFromArray:view.subviews];
depth++;
}
}
...
@autoreleasepool{
if (child.bounds.size.width < overlaySize.width * 0.8) continue;
NSString *childClass = [child.class className];
if ([childClass isEqualToString:@"CCUIModuleCollectionView"] ||
[childClass isEqualToString:@"CCUIHeaderPocketView"]) continue;
BOOL hostsSensorHeader = CCAViewTreeContainsClassName(child, @"CCUISensorAttributionPrivacyHeaderView");
BOOL fullScreenSurface = (child.bounds.size.width - overlaySize.width<0?-(child.bounds.size.width - overlaySize.width):child.bounds.size.width - overlaySize.width) < 8.0 &&
(child.bounds.size.height - overlaySize.height<0?-(child.bounds.size.height - overlaySize.height):child.bounds.size.height - overlaySize.height) < 8.0;
if (!hostsSensorHeader || !fullScreenSurface) continue;
for (UIView *surface in child.subviews) {
NSString *name = [surface.class className];
...
UIView *headerPocket = nil;
for (UIView *subview in overlay.view.subviews) {
if ([[subview.class className] isEqualToString:@"CCUIHeaderPocketView"]) {
headerPocket = subview;
break;
}
}
if (!headerPocket) return;
CGFloat pocketHeight = headerPocket.bounds.size.height;
for (UIView *child in headerPocket.subviews) {
if ([[child.class className] isEqualToString:@"MTMaterialView"]) {
child.hidden = YES;
child.alpha = 0.0;
child.layer.opacity = 0.0;
continue;
}
BOOL bottomHairline = child.bounds.size.width > headerPocket.bounds.size.width * 0.5 &&
child.bounds.size.height <= 2.5 &&
((child.frame.origin.y+child.frame.size.height<0?-((child.frame.origin.y+child.frame.size.height):(child.frame.origin.y+child.frame.size.height) - pocketHeight) <= 3.0;
if (bottomHairline) {
child.hidden = YES;
child.alpha = 0.0;
child.layer.opacity = 0.0;
...
for (CALayer *layer in headerPocket.layer.sublayers) {
BOOL bottomHairline = layer.bounds.size.width > headerPocket.bounds.size.width * 0.5 &&
layer.bounds.size.height <= 2.5 &&
((layer.frame.origin.y+layer.frame.size.height<0?-((layer.frame.origin.y+layer.frame.size.height):(layer.frame.origin.y+layer.frame.size.height) - pocketHeight) <= 3.0;
if (bottomHairline) {
layer.hidden = YES;
layer.opacity = 0.0;
}
...
static NSMutableDictionary *lastClampTimes = nil;
DO_ONCE({ lastClampTimes = [NSMutableDictionary dictionary]; });
NSString *key = [NSString stringWithFormat:@"%p", overlay];
CFTimeInterval now = CACurrentMediaTime();
NSNumber *last = lastClampTimes[key];
if (last && (now - last.doubleValue) < 0.016) return;
lastClampTimes[key] = @(now);
UIScrollView *scrollView = CCANativeScrollViewForOverlay(overlay);
...
NSValue *contentInsetValue = getAss(overlay,kCCANativeScrollContentInsetBaselineKey);
...
NSValue *boundsOriginValue = getAss(overlay,kCCANativeScrollBoundsOriginBaselineKey);
...
setAss(overlay,kCCANativeScrollContentInsetBaselineKey, [NSValue valueWithUIEdgeInsets:contentInset], 1);
}
scrollView.contentInset = contentInset;
scrollView.scrollIndicatorInsets = ((UIEdgeInsets){0,0,0,0});
scrollView.contentSize = viewportSize;
NSValue *boundsOriginValue = getAss(overlay,kCCANativeScrollBoundsOriginBaselineKey);
CGPoint boundsOrigin = boundsOriginValue ? boundsOriginValue.CGPointValue : scrollView.bounds.origin;
if (!boundsOriginValue) {
setAss(overlay,kCCANativeScrollBoundsOriginBaselineKey, [NSValue valueWithCGPoint:boundsOrigin], 1);
}
CGRect bounds = scrollView.bounds;
if ((bounds.origin.x - boundsOrigin.x<0?-(bounds.origin.x - boundsOrigin.x):bounds.origin.x - boundsOrigin.x) > 0.25 || (bounds.origin.y - boundsOrigin.y<0?-(bounds.origin.y - boundsOrigin.y):bounds.origin.y - boundsOrigin.y) > 0.25) {
bounds.origin = boundsOrigin;
scrollView.bounds = bounds;
}
NSValue *offsetValue = getAss(overlay,kCCANativeScrollBaselineKey);
CGPoint offset = offsetValue ? offsetValue.CGPointValue : scrollView.contentOffset;
if (!offsetValue) {
setAss(overlay,kCCANativeScrollBaselineKey, [NSValue valueWithCGPoint:offset], 1);
}
if ((scrollView.contentOffset.x - offset.x<0?-(scrollView.contentOffset.x - offset.x):scrollView.contentOffset.x - offset.x) > 0.25 || (scrollView.contentOffset.y - offset.y<0?-(scrollView.contentOffset.y - offset.y):scrollView.contentOffset.y - offset.y) > 0.25) {
[scrollView setContentOffset:offset animated:NO];
}
if (gCCAExpandedModuleOpen) return;
NSMutableArray*queue = [NSMutableArray arrayWithObject:overlay.view];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if (candidate != scrollView && [candidate isKindOfClass:[UIScrollView class]]) {
NSString *className = [candidate.class className];
...
internal.scrollIndicatorInsets = ((UIEdgeInsets){0,0,0,0});
if ([className isEqualToString:@"FCUIActivityListView"]) internal.scrollEnabled = NO;
if ([className isEqualToString:@"CCUIModuleCollectionView"]) [internal setContentOffset:((CGPoint){0,0}) animated:NO];
} else {
internal.alwaysBounceVertical = NO;
internal.alwaysBounceHorizontal = NO;
internal.bounces = NO;
...
BOOL smallerThanViewport = size.height <= internal.bounds.size.height + 2.0 &&
size.width <= internal.bounds.size.width + 2.0;
...
BOOL nearOverlayHeight = internal.bounds.size.height >= overlay.view.bounds.size.height - 12.0;
BOOL oversizedInBothAxes = size.height > internal.bounds.size.height + 48.0 &&
size.width > internal.bounds.size.width + 48.0;
if (genericScroll && nearOverlayHeight && oversizedInBothAxes) {
internal.contentInset = ((UIEdgeInsets){0,0,0,0});
internal.contentSize = internal.bounds.size;
[internal setContentOffset:((CGPoint){0,0}) animated:NO];
...
if ((current.x - target.x<0?-(current.x - target.x):current.x - target.x) > 0.25 || (current.y - target.y<0?-(current.y - target.y):current.y - target.y) > 0.25) {
...
UIScrollView *scrollView = CCANativeScrollViewForOverlay(overlay);
NSValue *baselineValue = getAss(overlay,kCCANativeScrollBoundsOriginBaselineKey);
if (!scrollView || !baselineValue) return 0.0;
if (gCCAControlCenterPresentationState != 1 && gCCAControlCenterPresentationState != 2) {
setAss(overlay,kCCANativeScrollOpeningCompensationKey, nil, 1);
return 0.0;
}
...
CGFloat compensation = (160.0<(-160.0>visibleOrigin.y - baselineValue.CGPointValue.y?160.0:MAX(-160.0, visibleOrigin.y - baselineValue.CGPointValue.y?-160.0:visibleOrigin.y - baselineValue.CGPointValue.y?160.0:MAX(-160.0, visibleOrigin.y - baselineValue.CGPointValue.y));
setAss(overlay,kCCANativeScrollOpeningCompensationKey, @(compensation), 1);
return compensation;
}
static void CCAStabilizeNativeScrollPresentationForOverlay(UIViewController *overlay) {
UIScrollView *scrollView = CCANativeScrollViewForOverlay(overlay);
if (!scrollView) return;
NSValue *baseValue = getAss(scrollView,kCCANativeScrollBaseSublayerTransformKey);
if (!baseValue) {
baseValue = [NSValue valueWithCATransform3D:scrollView.layer.sublayerTransform];
setAss(scrollView,kCCANativeScrollBaseSublayerTransformKey, baseValue, 1);
}
CATransform3D base = baseValue.CATransform3DValue;
if (gCCAControlCenterPresentationState == 1) {
NSValue *boundsBaselineValue = getAss(overlay,kCCANativeScrollBoundsOriginBaselineKey);
NSValue *offsetBaselineValue = getAss(overlay,kCCANativeScrollBaselineKey);
...
static NSMutableDictionary*gCCANativeLayoutRects;
static NSMutableDictionary*gCCACustomOrigins;
static NSMutableDictionary*gCCABaseLayoutSizes;
static NSMutableDictionary*gCCACustomSizes;
static NSMutableDictionary*gCCADuplicateFamilies;
static NSMutableDictionary*gCCAConnectivityOptimisticStates;
static NSMutableSet*gCCAPendingOptimisticCleanups;
static UIImage *gCCASheetScreenImage;
static NSDictionary*gCCASheetModuleFrames;
...
return CGRectMake(moduleFrame.origin.x + originOffset,moduleFrame.origin.y + originOffset,kCCARemoveHitSize,kCCARemoveHitSize);
}
...
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
BOOL fillsModule = (candidate.bounds.size.width - moduleSize.width<0?-(candidate.bounds.size.width - moduleSize.width):candidate.bounds.size.width - moduleSize.width) <= 4.0 &&
(candidate.bounds.size.height - moduleSize.height<0?-(candidate.bounds.size.height - moduleSize.height):candidate.bounds.size.height - moduleSize.height) <= 4.0;
if (fillsModule) {
...
@end
static BOOL CCARectArraysNearlyEqual(NSArray*a, NSArray*b) {
if (a == b) return 1;
if (a.count != b.count) return 0;
for (NSUInteger i = 0; i < a.count; i++) {
CGRect ra = a[i].CGRectValue;
CGRect rb = b[i].CGRectValue;
if ((ra.origin.x - rb.origin.x<0?-(ra.origin.x - rb.origin.x):ra.origin.x - rb.origin.x) > 0.25 ||
(ra.origin.y - rb.origin.y<0?-(ra.origin.y - rb.origin.y):ra.origin.y - rb.origin.y) > 0.25 ||
(ra.size.width - rb.size.width<0?-(ra.size.width - rb.size.width):ra.size.width - rb.size.width) > 0.25 ||
(ra.size.height - rb.size.height<0?-(ra.size.height - rb.size.height):ra.size.height - rb.size.height) > 0.25) return 0;
}
return 1;
}
@interface CCAEditGridView : UIView
@property (nonatomic, copy) NSArray*slotRects;
@property (nonatomic, copy) NSArray*occupiedRects;
@property (nonatomic, copy) NSArray*landingRects;
...
- (BOOL)rect:(CGRect)slot overlapsAny:(NSArray*)rects {
CGPoint center = CGPointMake(CGRectGetMidX(slot),CGRectGetMidY(slot));
for (NSValue *value in rects) if (CGRectContainsPoint(CGRectInset(value.CGRectValue, -2.0, -2.0), center)) return 1;
return 0;
}
- (void)layoutSubviews {
[super layoutSubviews];
...
- (void)setSlotRects:(NSArray*)slotRects {
...
CGFloat diameter = (slot.size.width<slot.size.height?slot.size.width:slot.size.height) * 0.92;
...
- (void)setOccupiedRects:(NSArray*)occupiedRects {
...
- (void)setLandingRects:(NSArray*)landingRects {
...
if (animated && (layer.opacity - target<0?-(layer.opacity - target):layer.opacity - target) > 0.01) {
...
if (self.hidden || !self.userInteractionEnabled || self.alpha <= 0.01) return 0;
BOOL small = [getAss(self,kCCASmallModuleChromeKey) boolValue];
if (self.tag == kCCAResizeButtonTag) {
CGFloat cornerSize = small ? 26.0 : 34.0;
CGRect corner = CGRectMake(self.bounds.size.width - cornerSize,self.bounds.size.height - cornerSize,cornerSize,cornerSize);
...
- (void)cca_checkForceTouches:(NSSet*)touches event:(UIEvent *)event {
if ([getAss(self,kCCAConnectivityForceFiredKey) boolValue]) return;
...
setAss(self,kCCAConnectivityForceFiredKey, @YES, 1);
...
setAss(self,kCCAConnectivityForceFiredKey, nil, 1);
...
BOOL fired = [getAss(self,kCCAConnectivityForceFiredKey) boolValue];
...
NSArray*modules = CCACollectModuleControllers(overlay);
...
UIButton *remove = getAss(module.view,kCCARemoveButtonKey);
UIButton *resize = getAss(module.view,kCCAResizeButtonKey);
...
BOOL small = [getAss(resize,kCCASmallModuleChromeKey) boolValue];
CGRect resizeFrame = [resize.superview convertRect:resize.frame toView:overlay.view];
CGRect resizeHitFrame = small ? CGRectMake((resizeFrame.origin.x+resizeFrame.size.width) - 30.0,(resizeFrame.origin.y+resizeFrame.size.height) - 30.0,30.0,30.0) : CGRectInset(resizeFrame, -16.0, -16.0);
...
BOOL small = [getAss(button,kCCASmallModuleChromeKey) boolValue];
CGRect resizeHit = small ? CGRectMake(button.bounds.size.width - 30.0,button.bounds.size.height - 30.0,30.0,30.0) : CGRectInset(button.bounds, -16.0, -16.0);
...
- (BOOL)pointInside:(CGPoint)point withEvent:(UIEvent *)event {
if (self.hidden || !self.userInteractionEnabled || self.alpha <= 0.01) return 0;
if (CGRectContainsPoint(self.bounds, point)) return 1;
...
if ([subview pointInside:childPoint withEvent:event]) return 1;
}
return 0;
}
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
...
- (BOOL)pointInside:(CGPoint)point withEvent:(UIEvent *)event {
if (self.hidden || self.alpha <= 0.01) return 0;
for (UIView *subview in self.subviews.reverseObjectEnumerator) {
if (subview.hidden || subview.alpha <= 0.01 || !subview.userInteractionEnabled) continue;
CGPoint childPoint = [self convertPoint:point toView:subview];
if ([subview pointInside:childPoint withEvent:event]) return 1;
...
- (void)setLevel:(CGFloat)level color:(UIColor *)color animated:(BOOL)animated {
level = (1.0<(0.0>level?1.0:MAX(0.0, level?0.0:level?1.0:MAX(0.0, level));
CGPoint center = CGPointMake(CGRectGetMidX(self.bounds),CGRectGetMidY(self.bounds));
CGFloat diskRadius = level <= 0.25 ? 5.1 : 6.1;
CGFloat innerRadius = 9.5;
CGFloat outerRadius = 11.0 + 6.0 * level;
UIBezierPath *disk = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(center.x - diskRadius,center.y - diskRadius,diskRadius * 2.0,diskRadius * 2.0)];
UIBezierPath *rays = [UIBezierPath bezierPath];
for (NSUInteger index = 0; index < 8; index++) {
CGFloat angle = (CGFloat)index * (CGFloat)M_PI_4;
[rays moveToPoint:CGPointMake(center.x + cos(angle) * innerRadius,center.y + sin(angle) * innerRadius)];
[rays addLineToPoint:CGPointMake(center.x + cos(angle) * outerRadius,center.y + sin(angle) * outerRadius)];
}
if (animated) {
...
- (void)loadView {
UIView *view = [[UIView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
...
@end
static BOOL prefB(NSString*k,BOOL f){Boolean v=0;BOOL r=CFPreferencesGetAppBooleanValue((__bridge CFStringRef)k,kCCAPrefsDomain,&v);return v?r:f;}
static void loadPrefs(void){CFPreferencesAppSynchronize(kCCAPrefsDomain);gE=prefB(@"Enabled",YES);gQB=prefB(@"QuickAccessButtonsEnabled",YES);gPG=prefB(@"PagingEnabled",YES);gBG=prefB(@"BlankSpaceGestureEnabled",YES);gAB=prefB(@"AddButtonEnabled",YES);gPB=prefB(@"PowerButtonEnabled",YES);gRB=prefB(@"RemovalButtonsEnabled",YES);gMB=prefB(@"ModuleBordersEnabled",YES);gBB=prefB(@"BorderBreathingEnabled",YES);gHB=prefB(@"HapticsEnabled",YES);}
...
CGFloat h = (native.width>native.height?native.width:native.height);
CGFloat w = (native.width<native.height?native.width:native.height);
cached = (h / w) < 1.9;
determined = YES;
return cached;
}
static BOOL CCAIsOverlayController(UIViewController *controller) {
NSString *name = [controller.class className];
...
[[controller.class className] containsString:@"ContentModuleContainerViewController"];
}
...
if ([[candidate.superview.class className] containsString:@"ContentModuleContainerView"]) {
return candidate;
}
...
NSArray*keys = @[@"moduleIdentifier", @"_moduleIdentifier"];
...
if (range.location == NSIntegerMax || range.location == 0 || range.location + 1 >= identifier.length) return 0;
NSString *suffix = [identifier substringFromIndex:range.location + 1];
if (!suffix.length) return 0;
return [suffix rangeOfCharacterFromSet:[[NSCharacterSet decimalDigitCharacterSet] invertedSet]].location == NSIntegerMax && suffix.integerValue > 1;
}
...
static NSString *CCANextDuplicateIdentifierForFamily(NSString *familyIdentifier, NSSet*present) {
if (!familyIdentifier.length) return nil;
NSMutableSet*used = [NSMutableSet setWithArray:gCCADuplicateFamilies.allKeys ?: @[]];
...
static NSUInteger CCADuplicateCountForFamily(NSString *familyIdentifier, NSSet*present) {
...
static id CCADynamicValue(id target, NSArray*selectors) {
...
static BOOL CCADynamicBool(id target, NSArray*selectors, BOOL fallback) {
for (NSString *selectorName in selectors) {
SEL selector = NSSelectorFromString(selectorName);
...
static BOOL CCADynamicSetBool(id target, NSArray*selectors, BOOL value) {
for (NSString *selectorName in selectors) {
SEL selector = NSSelectorFromString(selectorName);
...
id manager = CCADynamicSharedInstance(@"BluetoothManager");
NSArray *devices = nil;
@try{ devices = CCADynamicValue(manager, @[@"connectedDevices"]); }@catch(id e){}
...
static BOOL CCAConnectivitySelectedForIdentifier(NSString *identifier) {
NSString *lower = identifier.lowercaseString;
if (![lower containsString:@"ccaster.connectivity"]) return 0;
...
if ([lower containsString:@".airplane"]) {
DO_ONCE({ dlopen("/System/Library/PrivateFrameworks/Preferences.framework/Preferences", RTLD_LAZY); });
id radios = [NSClassFromString(@"RadiosPreferences") new];
...
if ([name containsString:@"tap"] || [name containsString:@"tun"] || [name containsString:@"ipsec"] || [name containsString:@"ppp"]) return 1;
}
return 0;
}
return 0;
...
NSString *lower = identifier.lowercaseString;
if (![lower containsString:@"ccaster.connectivity"]) return 1;
...
((NSInteger (*)(id, SEL))objc_msgSend)(asset, @selector(type)) : NSIntegerMax;
NSInteger kind = [asset respondsToSelector:@selector(kind)] ?
((NSInteger (*)(id, SEL))objc_msgSend)(asset, @selector(kind)) : NSIntegerMax;
if (stateIdentifier) {
...
NSNumber *previousState = getAss(slider,kCCASliderGlyphColoredKey);
...
NSMutableArray*glyphHosts = [NSMutableArray array];
...
if (!glyphHosts.count) {
NSMutableArray*queue = [NSMutableArray arrayWithArray:slider.subviews];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
NSString *className = [candidate.class className];
if (([candidate isKindOfClass:[UIImageView class]] || [className isEqualToString:@"CCUICAPackageView"]) &&
candidate.bounds.size.width <= 64.0 && candidate.bounds.size.height <= 64.0) [glyphHosts addObject:candidate];
[queue addObjectsFromArray:candidate.subviews];
}
}
for (UIView *host in glyphHosts) {
if (!getAss(host,kCCASliderGlyphOriginalTintKey)) {
setAss(host,kCCASliderGlyphOriginalTintKey, host.tintColor ?: [UIColor whiteColor], 1);
setAss(host,kCCASliderGlyphOriginalAlphaKey, @(host.alpha), 1);
setAss(host,kCCASliderGlyphOriginalHiddenKey, @(host.hidden), 1);
}
...
setAss(host,kCCASliderGlyphOriginalImageKey, imageView.image, 1);
}
void (^changes)(void) = ^{
...
host.hidden = YES;
if (imageView) {
UIImage *baseImage = getAss(host,kCCASliderGlyphOriginalImageKey) ?: imageView.image;
if (baseImage) {
...
[UIView transitionWithView:host duration:0.11 options:UIViewAnimationOptionTransitionCrossDissolve | 4<<16 | 8<<16 animations:changes completion:nil];
} else {
changes();
}
}
...
setAss(slider,kCCASliderGlyphSymbolStateKey, @"brightness.rays", 3);
setAss(slider,kCCASliderGlyphColoredKey, @(colored), 1);
return;
}
UIImageSymbolConfiguration *symbolConfiguration =
[UIImageSymbolConfiguration configurationWithPointSize:24.0 weight:UIImageSymbolWeightRegular];
CGFloat variableValue = (1.0<(0.0>value?1.0:MAX(0.0, value?0.0:value?1.0:MAX(0.0, value));
...
NSString *previousSymbolState = getAss(slider,kCCASliderGlyphSymbolStateKey);
...
setAss(slider,kCCASliderGlyphSymbolStateKey, symbolState, 3);
} else if (colorGlyph) {
colorGlyph.alpha = 0.0;
}
setAss(slider,kCCASliderGlyphColoredKey, @(colored), 1);
...
setAss(slider,kCCASliderOverscrollTargetKey,
[NSValue valueWithNonretainedObject:target],
1);
setAss(slider,kCCASliderOverscrollBaseTransformKey,
...
setAss(slider,kCCASliderOverscrollStartValueKey, @(value), 1);
setAss(slider,kCCASliderOverscrollAmountKey, @0.0, 1);
}
NSValue *baseValue = getAss(slider,kCCASliderOverscrollBaseTransformKey);
if (!baseValue) return;
UIView *target = [getAss(slider,kCCASliderOverscrollTargetKey) nonretainedObjectValue] ?: slider;
...
CGFloat tension = [getAss(slider,kCCASliderOverscrollAmountKey) doubleValue];
...
CGFloat springVelocity = flingingOutward ? -(2.2<(velocityY<0?-(velocityY?2.2:(velocityY<0?-(velocityY):velocityY) / 520.0) * tension : 0.0;
...
completion:^(BOOL finished) {
setAss(slider,kCCASliderOverscrollBaseTransformKey, nil, 1);
setAss(slider,kCCASliderOverscrollStartValueKey, nil, 1);
setAss(slider,kCCASliderOverscrollAmountKey, nil, 1);
setAss(slider,kCCASliderOverscrollTargetKey, nil, 1);
}];
return;
}
if (state != UIGestureRecognizerStateBegan && state != UIGestureRecognizerStateChanged) return;
if (slider.bounds.size.height <= slider.bounds.size.width * 1.15) return;
CGFloat startValue = [getAss(slider,kCCASliderOverscrollStartValueKey) doubleValue];
CGFloat translationY = [gesture translationInView:slider.window].y;
CGFloat rawValue = startValue - translationY / (1.0>slider.bounds.size.height?1.0:slider.bounds.size.height);
...
setAss(slider,kCCASliderOverscrollAmountKey, @(resisted), 1);
}
static NSArray*CCACollectModuleControllers(UIViewController *root) {
if (!root) return @[];
static NSMutableDictionary *cache = nil;
DO_ONCE({ cache = [NSMutableDictionary dictionary]; });
NSString *key = [NSString stringWithFormat:@"%p_%lu_%lu", root, (unsigned long)root.childViewControllers.count, (unsigned long)root.presentedViewController.hash];
...
NSArray *children = candidate.childViewControllers;
if (children.count) [queue addObjectsFromArray:children];
}
}
if (result.count) cache[key] = result;
...
if (getAss(overlay,kCCAExpansionPageGeometrySyncKey)) return;
id coordinator = ((id (*)(id, SEL))objc_msgSend)(NSClassFromString(@"CCAsterCoordinator"), @selector(shared));
...
setAss(collection.view,kCCAExpansionCollectionLayerPositionKey,
[NSValue valueWithCGPoint:collection.view.layer.position], 1);
CGAffineTransform base = [getAss(collection.view,kCCAOriginalTransformKey) CGAffineTransformValue];
CATransform3D sublayerBase = [getAss(collection.view,kCCAOriginalSublayerTransformKey) CATransform3DValue];
...
setAss(overlay,kCCAExpansionPageGeometrySyncKey, record, 1);
...
NSDictionary *record = getAss(overlay,kCCAExpansionPageGeometrySyncKey);
if (!record) return;
setAss(overlay,kCCAExpansionPageGeometrySyncKey, nil, 1);
...
NSArray*wrapperRecords = record[@"wrappers"];
...
UIView *collectionView = record[@"collection"];
if (![collectionView isKindOfClass:[UIView class]]) return;
CGAffineTransform base = [getAss(collectionView,kCCAOriginalTransformKey) CGAffineTransformValue];
CATransform3D sublayerBase = [getAss(collectionView,kCCAOriginalSublayerTransformKey) CATransform3DValue];
NSValue *positionValue = getAss(collectionView,kCCAExpansionCollectionLayerPositionKey);
CGFloat editOffset = gEditModeActive ? 0.0 : kCCARestingModuleOffset;
CGFloat pageOffset = -(CGFloat)gCCACurrentPage * CCAVisualPageSpan();
[collectionView.layer removeAnimationForKey:@"CCAsterPageStackSlide"];
[CATransaction begin];
...
setAss(overlay,kCCAExpansionGeometryHoldTokenKey, token, 1);
for (NSUInteger frame = 0; frame <= 42; frame++) {
NSTimeInterval delay = (NSTimeInterval)frame / 60.0;
dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(delay * NSEC_PER_SEC)),
dispatch_get_main_queue(), ^{
if (getAss(overlay,kCCAExpansionGeometryHoldTokenKey) != token) return;
...
if (!root) return 0;
NSString *className = [root.class className];
...
[className containsString:@"MRUControlCenter"]) return 1;
for (UIView *subview in root.subviews) {
if (CCAViewTreeContainsLiveExpansionContent(subview)) return 1;
}
return 0;
}
...
[UIView performWithoutAnimation:^{
[gCCAExpansionHiddenLiveViews enumerateObjectsUsingBlock:^(UIView *liveView, NSUInteger index, BOOL *stop) {
...
gCCAExpansionCompactDestinationWindowFrame = ((CGRect){{0,0},{0,0}});
gCCAExpansionExpandedContentAnchorWindow = ((CGPoint){0,0});
}
...
CCADiscardExpandedDismissalSnapshot();
if (!presented.view || !presented.view.superview || (presented.view.bounds.size.width<=0||presented.view.bounds.size.height<=0)) return;
...
NSMutableArray*liveViews = [NSMutableArray array];
if (expandedSurface) [liveViews addObject:expandedSurface];
NSMutableArray*queue = [NSMutableArray arrayWithArray:presented.view.subviews];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
...
CGFloat candidateArea = candidateFrame.size.width * candidateFrame.size.height;
CGFloat platterArea = snapshotFrame.size.width * snapshotFrame.size.height;
...
NSMutableArray*alphas = [NSMutableArray arrayWithCapacity:liveViews.count];
NSMutableArray*layerOpacities = [NSMutableArray arrayWithCapacity:liveViews.count];
...
if (!window || (startFrame.size.width<=0||startFrame.size.height<=0) || (gCCAExpansionCompactDestinationWindowFrame.size.width<=0||gCCAExpansionCompactDestinationWindowFrame.size.height<=0)) return;
...
foreground.bounds = (CGRect){((CGPoint){0,0}), gCCAExpansionCompactDestinationWindowFrame.size};
...
if ((frame.size.width<=0||frame.size.height<=0) || (frame.origin.y+frame.size.height) < -80.0 || frame.origin.y > overlay.view.bounds.size.height + 80.0) continue;
NSString *symbol = subview.tag == 181001 ? @"plus" : (subview.tag == 181002 ? @"power" : nil);
UIView *snapshot = nil;
if (symbol.length) {
CGRect localBounds = CGRectMake(0.0,0.0,frame.size.width,frame.size.height);
...
@try{ material = [sourceMaterial copy]; }@catch(id e){}
}
...
NSString *rootName = [root.class className];
...
NSMutableArray*queue = [NSMutableArray arrayWithObject:root];
NSUInteger depth = 0;
while (queue.count && depth < 120) {
@autoreleasepool{
UIView *view = queue.firstObject;
[queue removeObjectAtIndex:0];
for (UIView *subview in view.subviews) {
if ([[subview.class className] isEqualToString:className]) return subview;
...
if ([[ancestor.class className] isEqualToString:className]) return ancestor;
}
...
if (!glyph) {
glyph = [[UIImageView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
...
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([[candidate.class className] isEqualToString:className]) {
...
if (!module.view || !gCCAExpandedModuleOpen) return 0;
NSString *identifier = CCAModuleIdentifier(module);
if (identifier.length && [identifier isEqualToString:gCCAExpandedModuleIdentifier]) return 1;
...
if ([[container valueForKey:@"_expanded"] boolValue]) return 1;
}@catch(id e){}
}
return module.view.bounds.size.width > 190.0 || module.view.bounds.size.height > 190.0;
}
...
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([[candidate.class className] isEqualToString:@"CCUILabeledRoundButton"]) {
[candidate.layer removeAllAnimations];
candidate.hidden = YES;
candidate.alpha = 0.0;
candidate.layer.opacity = 0.0;
...
[[candidate.class className] isEqualToString:@"CCUIRoundButton"]) {
...
NSMutableArray*queue = [NSMutableArray arrayWithObject:(UIView *)button];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
...
NSMutableArray*queue = proxy ? [NSMutableArray arrayWithObject:proxy] : nil;
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
...
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([[candidate.class className] isEqualToString:@"MTMaterialView"]) {
CGFloat widthDelta = (candidate.bounds.size.width - root.bounds.size.width<0?-(candidate.bounds.size.width - root.bounds.size.width):candidate.bounds.size.width - root.bounds.size.width);
CGFloat heightDelta = (candidate.bounds.size.height - root.bounds.size.height<0?-(candidate.bounds.size.height - root.bounds.size.height):candidate.bounds.size.height - root.bounds.size.height);
...
if (animated) {
[UIView animateWithDuration:0.24 delay:0.0 options:0<<16 | 4<<16 | 1<<12 animations:changes completion:completion];
} else {
changes();
completion(YES);
}
...
NSArray*customSize = gCCACustomSizes[identifier];
if (customSize.count >= 2) {
size.width = ((NSUInteger)1>customSize[0].unsignedIntegerValue?(NSUInteger)1:customSize[0].unsignedIntegerValue);
size.height = ((NSUInteger)1>customSize[1].unsignedIntegerValue?(NSUInteger)1:customSize[1].unsignedIntegerValue);
return size;
}
NSValue *baseValue = gCCABaseLayoutSizes[identifier];
if (baseValue) {
[baseValue getValue:&size];
size.width = ((NSUInteger)1>size.width?(NSUInteger)1:size.width);
size.height = ((NSUInteger)1>size.height?(NSUInteger)1:size.height);
return size;
}
CGFloat width = module.view.bounds.size.width;
CGFloat height = module.view.bounds.size.height;
size.width = ((NSUInteger)1>(NSUInteger?(NSUInteger)1:(NSUInteger)llround((width + kCCAGridGap) / kCCAGridStep));
size.height = ((NSUInteger)1>(NSUInteger?(NSUInteger)1:(NSUInteger)llround((height + kCCAGridGap) / kCCAGridStep));
return size;
}
...
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([[candidate.class className] isEqualToString:@"CCUISteppedSliderView"]) {
...
UILabel *title = [[UILabel alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
title.tag = 1;
title.font = [UIFont systemFontOfSize:11.0 weight:2];
title.numberOfLines = 2;
title.lineBreakMode = NSLineBreakByTruncatingTail;
[presentation addSubview:title];
UILabel *status = [[UILabel alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
status.tag = 2;
...
objc_setAssociatedObject(presentation, @selector(CCALayoutOwnedCompactPresentation), cacheKey, 3);
...
if (logicalWidth < 1.0) logicalWidth = presentation.superview.bounds.size.width;
if (logicalHeight < 1.0) logicalHeight = presentation.superview.bounds.size.height;
UILabel *title = (UILabel *)[presentation viewWithTag:1];
UILabel *status = (UILabel *)[presentation viewWithTag:2];
UIImageView *glyph = CCAEnsureResizePresentationGlyph(presentation, symbolName);
BOOL showTitle = titleText.length && (gridSize.width > 1 || gridSize.height > 1);
...
CGFloat measuredTextWidth = gridSize.width > 1 && gridSize.height == 1 ? (0.0>logicalWidth - 83.0?0.0:logicalWidth - 83.0) :
(0.0>logicalWidth - measuredTextX - (gridSize.width > 1 ? 24.0 : 10.0?0.0:logicalWidth - measuredTextX - (gridSize.width > 1 ? 24.0 : 10.0));
...
CGFloat textX = 71.0;
CGFloat textWidth = (0.0>logicalWidth - 83.0?0.0:logicalWidth - 83.0);
...
CGFloat textWidth = (0.0>logicalWidth - textX - (gridSize.width > 1 ? 24.0 : 10.0?0.0:logicalWidth - textX - (gridSize.width > 1 ? 24.0 : 10.0));
CGFloat groupHeight = titleHeight + (showStatus ? lineHeight : 0.0);
CGFloat top = (kCCAGridCellSize + 7.0>logicalHeight - 17.3333 - groupHeight?kCCAGridCellSize + 7.0:logicalHeight - 17.3333 - groupHeight);
title.frame = CGRectMake(textX,top,textWidth,titleHeight);
status.frame = CGRectMake(textX,top + titleHeight,textWidth,lineHeight);
}
title.hidden = !showTitle;
...
if (animated) {
[UIView transitionWithView:presentation duration:0.18 options:UIViewAnimationOptionTransitionCrossDissolve | 4<<16 | 8<<16 animations:changes completion:^(BOOL finished) {
...
NSString *identifier = getAss(sender,kCCAConnectivityIdentifierKey);
...
material.alpha = brightenForEnable ? (1.0<materialRestAlpha + 0.16?1.0:materialRestAlpha + 0.16) : materialRestAlpha;
material.layer.opacity = material.alpha;
}
} completion:^(BOOL finished) {
...
NSNumber *previousSelected = getAss(module.view,kCCAConnectivitySelectedStateKey);
BOOL animateState = previousSelected && previousSelected.boolValue != selected;
setAss(module.view,kCCAConnectivitySelectedStateKey, @(selected), 1);
...
setAss(proxy,kCCAConnectivityForwardControlKey, nativeControl, 0);
setAss(proxy,kCCAConnectivityIdentifierKey, identifier, 3);
objc_setAssociatedObject(proxy, @selector(connectivityTileProxyTapped:), @(available), 1);
...
NSMutableArray*queue = [NSMutableArray arrayWithObject:module.view];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
...
static NSArray*CCACompactGlyphHosts(UIView *buttonView) {
...
if (!moduleView || !buttonView || !stableHost || getAss(moduleView,kCCAResizeGlyphHandoffViewKey)) return;
NSArray*glyphHosts = CCACompactGlyphHosts(buttonView);
...
NSMutableArray*hostStates = [NSMutableArray array];
...
setAss(moduleView,kCCAResizeGlyphHandoffViewKey, handoff, 1);
setAss(moduleView,kCCAResizeGlyphHandoffHostsKey, hostStates, 1);
[UIView performWithoutAnimation:^{
...
if (!moduleView) return;
UIView *handoff = getAss(moduleView,kCCAResizeGlyphHandoffViewKey);
NSArray*hostStates = getAss(moduleView,kCCAResizeGlyphHandoffHostsKey);
[UIView performWithoutAnimation:^{
for (NSDictionary *state in hostStates) ((UIView *)state[@"view"]).hidden = [state[@"hidden"] boolValue];
[handoff removeFromSuperview];
}];
setAss(moduleView,kCCAResizeGlyphHandoffViewKey, nil, 1);
setAss(moduleView,kCCAResizeGlyphHandoffHostsKey, nil, 1);
}
...
if (!rect.size.width || !rect.size.height || rect.origin.x + rect.size.width > 4 || rect.size.height > kCCAMinimumGridRows) return 0;
if (!CCALogicalRectRespectsColumnBands(rect)) return 0;
NSUInteger localRow = rect.origin.y % kCCAMinimumGridRows;
return localRow + rect.size.height <= kCCAMinimumGridRows;
}
static BOOL CCAPagedRectFits(NSString *identifier, CCUILayoutRect rect, NSDictionary*layout) {
if (!CCAPagedRectIsValid(rect)) return 0;
...
if (CCALogicalRectsOverlap(rect, other)) return 0;
}
return 1;
}
static BOOL CCAFindPagedSlot(NSString *identifier, CCUILayoutSize size, NSUInteger startPage, NSDictionary*layout, CCUILayoutPoint *destination) {
NSUInteger pageLimit = (kCCAMaxPages<(startPage + 2>layout.count + 2?kCCAMaxPages:MAX(startPage + 2, layout.count + 2?startPage + 2:layout.count + 2?kCCAMaxPages:MAX(startPage + 2, layout.count + 2));
...
static BOOL CCAGuaranteedPagedSlot(NSString *identifier, CCUILayoutSize size, NSUInteger startPage, NSDictionary*layout, CCUILayoutPoint *destination) {
...
if (CCAFindPagedSlot(identifier, clamped, startPage, layout, destination)) return 1;
if (startPage != 0 && CCAFindPagedSlot(identifier, clamped, 0, layout, destination)) return 1;
...
highestOccupiedPage = (highestOccupiedPage>CCAPageForRect(rect?highestOccupiedPage:CCAPageForRect(rect));
}
for (NSUInteger page = highestOccupiedPage + 1; page < kCCAMaxPages; page++) {
if (CCAFindPagedSlot(identifier, clamped, page, layout, destination)) return 1;
}
...
static BOOL CCALogicalRectFits(NSString *identifier, CCUILayoutRect rect, NSDictionary*layout, NSUInteger maxRows) {
if (rect.size.width == 0 || rect.size.height == 0 || rect.origin.x + rect.size.width > 4 || rect.origin.y + rect.size.height > maxRows) return 0;
if (!CCALogicalRectRespectsColumnBands(rect)) return 0;
for (NSString *otherIdentifier in layout) {
if ([otherIdentifier isEqualToString:identifier]) continue;
CCUILayoutRect other = {};
...
static BOOL CCALogicalLayoutIsLegal(NSDictionary*layout, NSUInteger maxRows) {
NSArray*identifiers = layout.allKeys;
for (NSUInteger first = 0; first < identifiers.count; first++) {
CCUILayoutRect a = {};
[layout[identifiers[first]] getValue:&a];
if (a.size.width == 0 || a.size.height == 0 || a.origin.x + a.size.width > 4 || a.origin.y + a.size.height > maxRows) return 0;
if (!CCALogicalRectRespectsColumnBands(a)) return 0;
for (NSUInteger second = first + 1; second < identifiers.count; second++) {
CCUILayoutRect b = {};
[layout[identifiers[second]] getValue:&b];
if (CCALogicalRectsOverlap(a, b)) return 0;
}
}
return 1;
}
static NSMutableDictionary*CCALayoutForPage(UIViewController *overlay, NSUInteger page, NSUInteger maxRows) {
...
static NSMutableDictionary*CCACurrentPageLayout(UIViewController *overlay, NSUInteger maxRows) {
...
if (!overlay.view) return (gCCACurrentPage<((NSUInteger?gCCACurrentPage:MAX((NSUInteger)1>gCCAPageCount?(NSUInteger?gCCACurrentPage:MAX((NSUInteger)1:gCCAPageCount) - 1);
...
if ((CGRectIntersection(visibleFrame, overlayBounds.size.width<=0||CGRectIntersection(visibleFrame, overlayBounds.size.height<=0))) continue;
NSNumber *key = @(page);
...
if (bestPage) return (bestPage.unsignedIntegerValue<((NSUInteger?bestPage.unsignedIntegerValue:MAX((NSUInteger)1>gCCAPageCount?(NSUInteger?bestPage.unsignedIntegerValue:MAX((NSUInteger)1:gCCAPageCount) - 1);
return (gCCACurrentPage<((NSUInteger?gCCACurrentPage:MAX((NSUInteger)1>gCCAPageCount?(NSUInteger?gCCACurrentPage:MAX((NSUInteger)1:gCCAPageCount) - 1);
}
...
- (void)setEditGridLandingRects:(NSArray*)rects forPage:(NSUInteger)page overlay:(UIViewController *)overlay;
...
- (NSArray*)enabledModuleIdentifiers;
- (NSArray*)fixedModuleIdentifiers;
- (NSArray*)availableControlCatalog;
...
- (NSArray*)temporarilyRevealModuleForSheetSnapshot:(UIView *)moduleView;
- (void)restoreModuleSheetSnapshotState:(NSArray*)records;
...
@property (nonatomic, strong) NSMutableDictionary*previewCache;
@end
@implementation CCAsterCoordinator
+ (instancetype)shared {
static CCAsterCoordinator *shared;
DO_ONCE({ shared = [self new]; });
return shared;
}
...
setAss(host,kCCAQuickAccessAnimationTokenKey, token, 1);
...
void (^completion)(BOOL) = ^(BOOL finished) {
if (getAss(host,kCCAQuickAccessAnimationTokenKey) != token) return;
host.hidden = shouldHide;
};
if (animated) {
[UIView animateWithDuration:0.28 delay:0.0 options:0<<16 | 4<<16 animations:changes completion:completion];
} else {
changes();
completion(YES);
}
...
while (container && ![[container.class className] isEqualToString:@"CCUIContentModuleContentContainerView"]) container = container.superview;
...
UIViewController *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([[candidate.class className] containsString:@"ModuleCollectionViewController"]) return candidate;
[queue addObjectsFromArray:candidate.childViewControllers];
}
return nil;
}
...
if (container && [[container.class className] containsString:@"ContentModuleContainerView"] && container.superview) {
CGSize size = container.bounds.size;
CGPoint anchor = container.layer.anchorPoint;
CGPoint position = container.layer.position;
CGRect untransformed = CGRectMake(position.x - anchor.x * size.width,position.y - anchor.y * size.height,size.width,size.height);
...
CGFloat baseX = frame.origin.x - logical.origin.x * kCCAGridStep;
CGFloat baseY = frame.origin.y - localRow * kCCAGridStep - ((CGFloat)((NSInteger)page - (NSInteger)gCCACurrentPage) * span) - gCCAPagerInteractiveTranslation;
fallback.x = (fallback.x<baseX?fallback.x:baseX);
fallback.y = (fallback.y<baseY?fallback.y:baseY);
}
if (fallback.x == CGFLOAT_MAX || fallback.y == CGFLOAT_MAX) {
CGFloat width = overlay.view ? overlay.view.bounds.size.width : UIScreen.mainScreen.bounds.size.width;
...
UIView *container = getAss(stale,kCCAOwnedDuplicateContainerKey);
...
UIView *presentation = [[UIView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
presentation.backgroundColor = [UIColor clearColor];
...
setAss(duplicate,kCCAOwnedDuplicateContainerKey, container, 1);
setAss(duplicate,kCCAOwnedDuplicatePresentationKey, presentation, 1);
[duplicate didMoveToParentViewController:overlay];
existing[identifier] = duplicate;
createdDuplicate = YES;
} else {
UIView *container = getAss(duplicate,kCCAOwnedDuplicateContainerKey);
UIView *presentation = getAss(duplicate,kCCAOwnedDuplicatePresentationKey);
if (!container || !presentation) {
[duplicate.view removeFromSuperview];
container = [[UIView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
container.backgroundColor = [UIColor clearColor];
container.opaque = NO;
container.clipsToBounds = NO;
presentation = [[UIView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
presentation.backgroundColor = [UIColor clearColor];
presentation.opaque = NO;
presentation.clipsToBounds = NO;
[container addSubview:presentation];
...
CGRect frame = CGRectMake(base.x + rect.origin.x * kCCAGridStep,base.y + localRow * kCCAGridStep + ((CGFloat)((NSInteger)page - (NSInteger)gCCACurrentPage) * span) + gCCAPagerInteractiveTranslation,pointSize.width,pointSize.height);
UIView *container = getAss(child,kCCAOwnedDuplicateContainerKey);
UIView *presentation = getAss(child,kCCAOwnedDuplicatePresentationKey);
...
container.bounds = (CGRect){((CGPoint){0,0}), pointSize};
container.center = frameCenter;
presentation.bounds = (CGRect){((CGPoint){0,0}), pointSize};
presentation.center = CGPointMake(pointSize.width * 0.5,pointSize.height * 0.5);
child.view.bounds = (CGRect){((CGPoint){0,0}), pointSize};
...
UIButton *remove = getAss(child.view,kCCARemoveButtonKey);
UIButton *resize = getAss(child.view,kCCAResizeButtonKey);
if (border && !gCCAResizeInProgress) {
CGRect presentationFrame = CGRectMake(child.view.frame.origin.x,child.view.frame.origin.y,child.view.bounds.size.width,child.view.bounds.size.height);
...
UIView *host = [[CCAQuickAccessHostView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
host.tag = 181000;
host.backgroundColor = [UIColor clearColor];
host.userInteractionEnabled = YES;
...
CGFloat hostOriginY = (animationHost.frame.origin.y>hostFrameInOverlay.origin.y?animationHost.frame.origin.y:hostFrameInOverlay.origin.y);
CGFloat hostOriginX = (animationHost.frame.origin.x>hostFrameInOverlay.origin.x?animationHost.frame.origin.x:hostFrameInOverlay.origin.x);
[NSLayoutConstraint activateConstraints:@[
...
[host.widthAnchor constraintEqualToConstant:controller.view.bounds.size.width],
...
- (void)normalizePagedLayoutForOverlay:(UIViewController *)overlay {
if (!overlay) return;
static NSMutableDictionary *normalizeDebounces = nil;
DO_ONCE({ normalizeDebounces = [NSMutableDictionary dictionary]; });
NSString *key = [NSString stringWithFormat:@"%p", overlay];
NSNumber *existing = normalizeDebounces[key];
if (existing && CACurrentMediaTime() - existing.doubleValue < 0.05) return;
normalizeDebounces[key] = @(CACurrentMediaTime());
[self syncOwnedDuplicateModulesForOverlay:overlay];
NSArray*modules = CCACollectModuleControllers(overlay);
if (!modules.count) return;
NSMutableDictionary*moduleByIdentifier = [NSMutableDictionary dictionary];
for (UIViewController *module in modules) {
NSString *identifier = CCAModuleIdentifier(module);
...
NSArray*enabledForPrune = [self enabledModuleIdentifiers];
...
NSArray*savedSize = gCCACustomSizes[identifier];
...
NSArray*savedOrigin = gCCACustomOrigins[identifier];
...
highestPage = (highestPage>CCAPageForRect(desired?highestPage:CCAPageForRect(desired));
...
gCCAOccupiedPageCount = ((NSUInteger)1>highestPage + 1?(NSUInteger)1:highestPage + 1);
gCCAPageCount = (kCCAMaxPages<gCCAOccupiedPageCount + (gEditModeActive && gCCAOccupiedPageCount < kCCAMaxPages ? 1 : 0?kCCAMaxPages:gCCAOccupiedPageCount + (gEditModeActive && gCCAOccupiedPageCount < kCCAMaxPages ? 1 : 0));
if (gCCAPendingPageAfterRebuild != NSIntegerMax) {
gCCACurrentPage = (gCCAPendingPageAfterRebuild<gCCAPageCount - 1?gCCAPendingPageAfterRebuild:gCCAPageCount - 1);
gCCAPendingPageAfterRebuild = NSIntegerMax;
} else {
gCCACurrentPage = (gCCACurrentPage<gCCAPageCount - 1?gCCACurrentPage:gCCAPageCount - 1);
}
if (changed) {
CFPreferencesSetAppValue(CFSTR("ModuleGridOrigins"), (__bridge CFPropertyListRef)[gCCACustomOrigins copy], kCCAPrefsDomain);
CFPreferencesAppSynchronize(kCCAPrefsDomain);
...
setAss(module.view,kCCAPageHiddenKey, @(pageHidden), 1);
[CATransaction begin];
[CATransaction setDisableActions:YES];
...
if (!fade) {
fade = [[CCATopFadeView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
...
CGFloat height = (112.0>overlay.view.safeAreaInsets.top + 76.0?112.0:overlay.view.safeAreaInsets.top + 76.0);
fade.frame = CGRectMake(0.0,0.0,overlay.view.bounds.size.width,height);
BOOL active = gCCAControlCenterPresented && !gCCAExpandedModuleOpen &&
(gCCAPagerScrubbingActive || gCCAPagerTransitionActive || (gCCAPagerInteractiveTranslation<0?-(gCCAPagerInteractiveTranslation):gCCAPagerInteractiveTranslation) > 0.5);
fade.hidden = !active;
fade.alpha = active ? 1.0 : 0.0;
UIView *quickAccess = [overlay.view viewWithTag:181000];
if (quickAccess && !quickAccess.hidden) [overlay.view bringSubviewToFront:quickAccess];
for (UIViewController *child in overlay.childViewControllers) {
NSString *name = [child.class className];
...
for (UIView *subview in overlay.view.subviews) {
NSString *name = [subview.class className];
...
(gCCAPagerScrubbingActive || gCCAPagerTransitionActive || (gCCAPagerInteractiveTranslation<0?-(gCCAPagerInteractiveTranslation):gCCAPagerInteractiveTranslation) > 0.5);
CGFloat target = active ? (1.0<(0.0>alpha?1.0:MAX(0.0, alpha?0.0:alpha?1.0:MAX(0.0, alpha)) : 0.0;
...
UIView *host = [overlay.view viewWithTag:kCCAOwnedDuplicateHostTag];
if (!host) return;
CGFloat clamped = (1.0<(0.0>alpha?1.0:MAX(0.0, alpha?0.0:alpha?1.0:MAX(0.0, alpha));
...
if (![child isKindOfClass:[CCAOwnedDuplicateModuleViewController class]]) continue;
CCAOwnedDuplicateModuleViewController *duplicate = (CCAOwnedDuplicateModuleViewController *)child;
UIView *duplicateContainer = getAss(child,kCCAOwnedDuplicateContainerKey);
UIView *duplicatePresentation = getAss(child,kCCAOwnedDuplicatePresentationKey);
...
(CCANativeScrollOpeningCompensation(overlay<0?-(CCANativeScrollOpeningCompensation(overlay):CCANativeScrollOpeningCompensation(overlay)) <= 0.5) {
CCAFinishNativeScrollOpeningStabilization(overlay);
}
}
if (gCCAUseNativeOpeningCompensation &&
(gCCAControlCenterPresentationState == 1 || gCCAControlCenterPresentationState == 2)) {
static CFTimeInterval lastFlush = 0;
CFTimeInterval now = CACurrentMediaTime();
if (now - lastFlush > 0.032) {
lastFlush = now;
[CATransaction flush];
}
}
...
UIButton *remove = getAss(module.view,kCCARemoveButtonKey);
UIButton *resize = getAss(module.view,kCCAResizeButtonKey);
setAss(module.view,kCCAPageHiddenKey, @NO, 1);
if (gEditModeActive) {
...
[UIView animateWithDuration:duration delay:0.0 options:UIViewAnimationOptionCurveEaseOut | 4<<16 animations:^{
...
if (token && getAss(overlay,kCCAPageAnimationTokenKey) != token) return;
...
if (!collection.view) return;
if (gCCAPagerScrubbingActive) {
NSValue *boundsValue = getAss(collection.view,kCCAScrubCollectionBoundsKey);
NSValue *positionValue = getAss(collection.view,kCCAScrubCollectionPositionKey);
...
if (animated) {
id token = [NSObject new];
setAss(overlay,kCCAPageAnimationTokenKey, token, 1);
...
dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(duration * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
if (getAss(overlay,kCCAPageAnimationTokenKey) != token) return;
...
changes();
[CATransaction commit];
if (!gCCAPagerTransitionActive && (gCCAPagerInteractiveTranslation<0?-(gCCAPagerInteractiveTranslation):gCCAPagerInteractiveTranslation) < 0.01) [self updatePagedModuleVisibilityForOverlay:overlay showAdjacent:NO];
}
}
- (void)animatePageSettleForOverlay:(UIViewController *)overlay
duration:(NSTimeInterval)duration
...
NSMutableArray*layers = [NSMutableArray arrayWithObject:collection.view.layer];
UIView *gridStack = getAss(overlay,kCCAEditGridStackKey);
if (gridStack.layer) [layers addObject:gridStack.layer];
NSMutableArray*starts = [NSMutableArray arrayWithCapacity:layers.count];
...
[layers enumerateObjectsUsingBlock:^(CALayer *layer, NSUInteger index, BOOL *stop) {
...
gCCACurrentPage = (page<gCCAPageCount - 1?page:gCCAPageCount - 1);
...
(gCCAPagerInteractiveTranslation<0?-(gCCAPagerInteractiveTranslation):gCCAPagerInteractiveTranslation) >= 0.01) return;
CCARestoreNativeScrollBaseline(overlay);
});
}
}
...
if ([getAss(host,kCCAPageIndicatorDraggingKey) boolValue]) return;
CCAHaptic();
...
gCCAPagerTransitionActive = YES;
gCCAPagerInteractiveStartPage = (startPage<gCCAPageCount - 1?startPage:gCCAPageCount - 1);
...
[self capturePresentationStateForView:collection.view];
if (collection.view) {
setAss(collection.view,kCCAScrubCollectionBoundsKey,
[NSValue valueWithCGRect:collection.view.layer.bounds],
1);
setAss(collection.view,kCCAScrubCollectionPositionKey,
[NSValue valueWithCGPoint:collection.view.layer.position],
1);
}
if (gEditModeActive) {
NSMutableSet*seenWrappers = [NSMutableSet set];
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
...
setAss(wrapper,kCCAEditScrubWrapperBaseTransformKey,
...
CGFloat clamped = (maxProgress<(0.0>progress?maxProgress:MAX(0.0, progress?0.0:progress?maxProgress:MAX(0.0, progress));
...
dt = (0.050<(1.0 / 120.0>dt?0.050:MAX(1.0 / 120.0, dt?1.0 / 120.0:dt?0.050:MAX(1.0 / 120.0, dt));
CGFloat rawVelocity = (physicsProgress - gCCAPagerPreviousRawProgress) / dt;
rawVelocity = (8.0<(-8.0>rawVelocity?8.0:MAX(-8.0, rawVelocity?-8.0:rawVelocity?8.0:MAX(-8.0, rawVelocity));
...
NSUInteger candidate = (NSUInteger)llround((maxProgress<(0.0>visualProgress?maxProgress:MAX(0.0, visualProgress?0.0:visualProgress?maxProgress:MAX(0.0, visualProgress)));
...
CGFloat overlayHeight = overlay.view.bounds.size.height;
...
CGFloat pull = (1.0<(0.0>(firstIconY - fingerY?1.0:MAX(0.0, (firstIconY - fingerY?0.0:(firstIconY - fingerY?1.0:MAX(0.0, (firstIconY - fingerY) / (1.0>firstIconY - upperLimitY?1.0:firstIconY - upperLimitY)));
CGFloat eased = 1.0 - pow(1.0 - pull, 1.35);
translationTarget = -(100.0<overlayHeight * 0.12?100.0:overlayHeight * 0.12) * eased;
endpointPull = YES;
...
CGFloat pull = (1.0<(0.0>(fingerY - lastIconY?1.0:MAX(0.0, (fingerY - lastIconY?0.0:(fingerY - lastIconY?1.0:MAX(0.0, (fingerY - lastIconY) / (1.0>lowerLimitY - lastIconY?1.0:lowerLimitY - lastIconY)));
CGFloat eased = 1.0 - pow(1.0 - pull, 1.35);
translationTarget = (100.0<overlayHeight * 0.12?100.0:overlayHeight * 0.12) * eased;
endpointPull = YES;
} else {
...
(1.0<(0.0>(CACurrentMediaTime(?1.0:MAX(0.0, (CACurrentMediaTime(?0.0:(CACurrentMediaTime(?1.0:MAX(0.0, (CACurrentMediaTime() - gCCAPagerInteractiveBeganTime) / 0.26)) : 1.0;
...
CGFloat jello = (kCCAPagerMaximumJelloScale<(-kCCAPagerMaximumJelloScale>jelloInput?kCCAPagerMaximumJelloScale:MAX(-kCCAPagerMaximumJelloScale, jelloInput?-kCCAPagerMaximumJelloScale:jelloInput?kCCAPagerMaximumJelloScale:MAX(-kCCAPagerMaximumJelloScale, jelloInput)) * entrance;
...
UIViewController *collection = [self moduleCollectionControllerInOverlay:overlay];
CGFloat baseAlpha = [getAss(collection.view,kCCAOriginalAlphaKey) doubleValue];
...
if ([seenWrappers containsObject:key]) continue;
[seenWrappers addObject:key];
NSValue *baseValue = getAss(wrapper,kCCAEditScrubWrapperBaseTransformKey);
if (!baseValue) {
baseValue = [NSValue valueWithCGAffineTransform:wrapper.transform];
setAss(wrapper,kCCAEditScrubWrapperBaseTransformKey, baseValue, 1);
}
...
host.frame = CGRectMake(overlay.view.bounds.size.width - kCCAPageIndicatorScrubHostWidth - kCCAPageIndicatorScrubRightInset,hostMinY,kCCAPageIndicatorScrubHostWidth,hostHeight);
[host.subviews enumerateObjectsUsingBlock:^(__kindof UIView *button, NSUInteger page, BOOL *stop) {
...
CGFloat proximity = (0.0>1.0 - (touchY - centerY<0?-(touchY - centerY?0.0:1.0 - (touchY - centerY<0?-(touchY - centerY):touchY - centerY) / (gEditModeActive ? 92.0 : 78.0));
if (gEditModeActive) proximity = selected ? (0.72>proximity?0.72:proximity) : proximity * 0.58;
CGFloat scale = 1.18 + 1.68 * proximity + (selected ? 0.18 : 0.0);
CGFloat pointSize = (38.0<CCAPageIndicatorBasePointSizeForPage(page?38.0:CCAPageIndicatorBasePointSizeForPage(page) * scale);
UIImageSymbolConfiguration *configuration = [UIImageSymbolConfiguration configurationWithPointSize:pointSize weight:UIImageSymbolWeightSemibold];
...
CGFloat targetAlpha = (1.0<(selected ? 0.86 : 0.28?1.0:(selected ? 0.86 : 0.28) + 0.36 * proximity);
...
if (gEditModeActive) {
[UIView animateWithDuration:0.08 delay:0.0 options:UIViewAnimationOptionCurveEaseOut | 4<<16 | 1<<12 animations:layoutPager completion:nil];
} else {
layoutPager();
}
[self updateTopFadeForOverlay:overlay presentationAlpha:1.0];
...
NSUInteger target = (targetPage<gCCAPageCount - 1?targetPage:gCCAPageCount - 1);
UIViewController *collection = [self moduleCollectionControllerInOverlay:overlay];
...
if (clearBaseline) setAss(wrapper,kCCAEditScrubWrapperBaseTransformKey, nil, 1);
}
};
if (gEditModeActive) {
[UIView performWithoutAnimation:^{
...
NSMutableDictionary*pageGrids = getAss(overlay,kCCAEditPageGridsKey);
...
gCCAPagerScrubbingActive = NO;
gCCAPagerTransitionActive = NO;
setAss(collection.view,kCCAScrubCollectionBoundsKey, nil, 1);
setAss(collection.view,kCCAScrubCollectionPositionKey, nil, 1);
CCAReassertNativeScrollClampForOverlay(overlay);
gCCAPagerViscousProgress = (CGFloat)target;
gCCAPagerFilteredVelocity = 0.0;
gCCAPagerLastSampleTime = 0.0;
UIView *host = [overlay.view viewWithTag:kCCAPageIndicatorHostTag];
setAss(host,kCCAPageIndicatorDraggingKey, nil, 1);
[self applyPageTransformToOverlay:overlay animated:NO];
[self updatePagedModuleVisibilityForOverlay:overlay showAdjacent:NO];
[self updatePageIndicatorsForOverlay:overlay];
[self updateTopFadeForOverlay:overlay presentationAlpha:0.0];
...
setAss(host,kCCAPageIndicatorDraggingKey, @YES, 1);
setAss(gesture,kCCAPagerStartPageKey, @(gCCACurrentPage), 1);
[self beginInteractivePageTransitionForOverlay:overlay startPage:gCCACurrentPage];
...
NSUInteger startPage = [getAss(gesture,kCCAPagerStartPageKey) unsignedIntegerValue];
NSUInteger target = gesture.state == UIGestureRecognizerStateEnded ? (NSUInteger)llround(((CGFloat)gCCAPageCount - 1.0<(0.0>progress?(CGFloat?0.0:progress?(CGFloat)gCCAPageCount - 1.0:(0.0>progress?0.0:progress))) : startPage;
setAss(gesture,kCCAPagerStartPageKey, nil, 1);
...
NSUInteger target = (NSUInteger)llround(((CGFloat)gCCAPageCount - 1.0<(0.0>gCCAPagerInteractiveProgress?(CGFloat?0.0:gCCAPagerInteractiveProgress?(CGFloat)gCCAPageCount - 1.0:(0.0>gCCAPagerInteractiveProgress?0.0:gCCAPagerInteractiveProgress)));
[self finishInteractivePageTransitionForOverlay:overlay targetPage:target];
}
...
CGFloat scrubHostHeight = kCCAPageIndicatorScrubStep * gCCAPageCount;
CGFloat scrubHostMinY = floor((windowView.bounds.size.height - scrubHostHeight) * 0.5);
...
UIView *host = [overlay.view viewWithTag:kCCAPageIndicatorHostTag];
if (!host) {
host = [[UIView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
host.tag = kCCAPageIndicatorHostTag;
host.backgroundColor = [UIColor clearColor];
host.userInteractionEnabled = YES;
[overlay.view addSubview:host];
}
UIPanGestureRecognizer *indicatorPan = getAss(host,kCCAPageIndicatorPanKey);
if (!indicatorPan) {
...
setAss(indicatorPan,kCCAOwnGestureKey, @YES, 1);
setAss(host,kCCAPageIndicatorPanKey, indicatorPan, 1);
...
if ([getAss(host,kCCAPageIndicatorDraggingKey) boolValue]) {
...
NSUInteger previousCount = [getAss(host,kCCAPageIndicatorCountKey) unsignedIntegerValue];
BOOL countChanged = previousCount != gCCAPageCount;
if (host.subviews.count > gCCAPageCount) {
NSArray*extra = [host.subviews subarrayWithRange:NSMakeRange(gCCAPageCount, host.subviews.count - gCCAPageCount)];
[UIView animateWithDuration:0.18 delay:0.0 options:0<<16 | 4<<16 animations:^{
...
objc_setAssociatedObject(button, @selector(pageIndicatorTapped:), @(page), 1);
[host addSubview:button];
}
setAss(host,kCCAPageIndicatorCountKey, @(gCCAPageCount), 1);
...
CGRect targetHostFrame = CGRectMake(overlay.view.bounds.size.width - hostWidth - rightInset,floor((overlay.view.bounds.size.height - hostHeight) * 0.5),hostWidth,hostHeight);
...
[UIView animateWithDuration:0.24 delay:0.0 options:0<<16 | 4<<16 | 1<<12 animations:layoutIndicators completion:nil];
} else {
[UIView animateWithDuration:0.22 delay:0.0 options:0<<16 | 4<<16 | 1<<12 animations:layoutIndicators completion:nil];
}
...
CCAClampNativeScrollViewForOverlay(overlay);
setAss(gesture,kCCAPagerNativeScrollViewKey, nativeScrollView, 1);
setAss(gesture,kCCAPagerNativeOffsetKey, nativeBaseline, 1);
}
NSMutableArray*suppressed = [NSMutableArray array];
NSMutableArray*viewQueue = [NSMutableArray arrayWithObject:overlay.view];
...
if (other == gesture || [getAss(other,kCCAOwnGestureKey) boolValue]) continue;
...
setAss(gesture,kCCAPagerSuppressedGesturesKey, suppressed, 1);
return;
}
NSUInteger startPage = [getAss(gesture,kCCAPagerStartPageKey) unsignedIntegerValue];
...
target = (0>((NSInteger?0:((NSInteger)gCCAPageCount - 1<target?(NSInteger)gCCAPageCount - 1:target));
UIScrollView *nativeScrollView = getAss(gesture,kCCAPagerNativeScrollViewKey);
NSValue *nativeOffsetValue = getAss(gesture,kCCAPagerNativeOffsetKey);
CGPoint nativeOffset = nativeOffsetValue ? nativeOffsetValue.CGPointValue : ((CGPoint){0,0});
if (nativeScrollView && nativeOffsetValue) {
CCAClampNativeScrollViewForOverlay(overlay);
[nativeScrollView setContentOffset:nativeOffset animated:NO];
}
NSArray*suppressedGestures = getAss(gesture,kCCAPagerSuppressedGesturesKey);
if (gEditModeActive) {
[self updatePagedModuleVisibilityForOverlay:overlay showAdjacent:YES];
NSInteger delta = (NSInteger)startPage - target;
gCCACurrentPage = startPage;
CGFloat finalTranslation = (CGFloat)delta * CCAVisualPageSpan();
CGFloat remaining = (finalTranslation - gCCAPagerInteractiveTranslation<0?-(finalTranslation - gCCAPagerInteractiveTranslation):finalTranslation - gCCAPagerInteractiveTranslation);
CGFloat releaseVelocity = (velocity.y<0?-(velocity.y):velocity.y);
CGFloat distanceFactor = (1.0<remaining / (CCAVisualPageSpan(?1.0:remaining / MAX(CCAVisualPageSpan()>1.0?CCAVisualPageSpan(?1.0:remaining / MAX(CCAVisualPageSpan():1.0));
CGFloat velocityFactor = (1.0<releaseVelocity / 1800.0?1.0:releaseVelocity / 1800.0);
NSTimeInterval duration = (0.62<(0.18>0.22 + distanceFactor * 0.34 - velocityFactor * 0.28?0.62:MAX(0.18, 0.22 + distanceFactor * 0.34 - velocityFactor * 0.28?0.18:0.22 + distanceFactor * 0.34 - velocityFactor * 0.28?0.62:MAX(0.18, 0.22 + distanceFactor * 0.34 - velocityFactor * 0.28));
...
if (delay.doubleValue >= 0.4 && (gCCAPagerInteractiveTranslation<0?-(gCCAPagerInteractiveTranslation):gCCAPagerInteractiveTranslation) < 0.01) [self applyPageTransformToOverlay:overlay animated:NO];
});
}
}
setAss(gesture,kCCAPagerStartPageKey, nil, 1);
setAss(gesture,kCCAPagerSuppressedGesturesKey, nil, 1);
setAss(gesture,kCCAPagerNativeScrollViewKey, nil, 1);
setAss(gesture,kCCAPagerNativeOffsetKey, nil, 1);
}
}
- (void)installPagingOnOverlay:(UIViewController *)overlay {
...
if ([getAss(gesture,kCCAPagerGestureKey) boolValue]) { pager = (UIPanGestureRecognizer *)gesture; break; }
}
if (!pager) {
...
pager.delegate = self;
setAss(pager,kCCAOwnGestureKey, @YES, 1);
setAss(pager,kCCAPagerGestureKey, @YES, 1);
...
if (getAss(pager,kCCAPagerModulePanDependencyKey) != gesture) {
[pager requireGestureRecognizerToFail:gesture];
setAss(pager,kCCAPagerModulePanDependencyKey, gesture, 1);
}
break;
}
...
setAss(blankHold,kCCAOwnGestureKey, @YES, 1);
objc_setAssociatedObject(blankHold, @selector(blankHeld:), @YES, 1);
...
setAss(editExitTap,kCCAOwnGestureKey, @YES, 1);
...
setAss(editDismissPan,kCCAOwnGestureKey, @YES, 1);
setAss(editDismissPan,kCCAEditDismissPanKey, @YES, 1);
...
setAss(modulePan,kCCAOwnGestureKey, @YES, 1);
objc_setAssociatedObject(modulePan, @selector(modulePanned:), @"overlayPan", 3);
...
if (!collection.view) return;
[self capturePresentationStateForView:collection.view];
CGAffineTransform collectionBase = [getAss(collection.view,kCCAOriginalTransformKey) CGAffineTransformValue];
CATransform3D sublayerBase = [getAss(collection.view,kCCAOriginalSublayerTransformKey) CATransform3DValue];
...
CGAffineTransform base = [getAss(wrapper,kCCAOriginalTransformKey) CGAffineTransformValue];
wrapper.transform = base;
}
}
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gesture {
if ([getAss(gesture,kCCAEditDismissPanKey) boolValue]) {
if (!gEditModeActive || gCCAExpandedModuleOpen || gCCADragInProgress || gCCAResizeInProgress) return 0;
CGPoint location = [gesture locationInView:gesture.view];
if (location.y <= gesture.view.bounds.size.height - (92.0>gesture.view.safeAreaInsets.bottom + 68.0?92.0:gesture.view.safeAreaInsets.bottom + 68.0)) return 0;
CGPoint velocity = [(UIPanGestureRecognizer *)gesture velocityInView:gesture.view];
return velocity.y < -80.0 && (velocity.y<0?-(velocity.y):velocity.y) > (velocity.x<0?-(velocity.x):velocity.x);
}
if ([getAss(gesture,kCCAPagerGestureKey) boolValue]) {
if (!gPagingEnabled || gCCAPageCount <= 1 || gCCAExpandedModuleOpen ||
gCCADragInProgress || gCCAResizeInProgress) return 0;
CGPoint velocity = [(UIPanGestureRecognizer *)gesture velocityInView:gesture.view];
CGPoint location = [gesture locationInView:gesture.view];
if (location.y > gesture.view.bounds.size.height - (92.0>gesture.view.safeAreaInsets.bottom + 68.0?92.0:gesture.view.safeAreaInsets.bottom + 68.0)) return 0;
if (!gCCADragInProgress && gCCACurrentPage + 1 >= gCCAPageCount && velocity.y < 0.0) return 0;
return (velocity.y<0?-(velocity.y):velocity.y) > (velocity.x<0?-(velocity.x):velocity.x) * 1.12;
}
return 1;
}
...
return location.y > gesture.view.bounds.size.height - (92.0>gesture.view.safeAreaInsets.bottom + 68.0?92.0:gesture.view.safeAreaInsets.bottom + 68.0);
}
if ([getAss(gesture,kCCAPagerGestureKey) boolValue]) {
if (!gPagingEnabled || gCCAPageCount <= 1 || gCCAExpandedModuleOpen ||
gCCADragInProgress || gCCAResizeInProgress) return 0;
...
candidate.tag == kCCAResizeButtonTag || candidate.tag == kCCAAddControlButtonTag || candidate.tag == 181000) return 0;
NSString *name = [candidate.class className];
if ([name containsString:@"Slider"]) return 0;
candidate = candidate.superview;
}
if (gEditModeActive) {
UIViewController *overlay = gOverlayControllers.allObjects.firstObject;
...
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
if (module.view.hidden || module.view.alpha <= 0.01 || CCAModuleViewIsPageHidden(module.view)) continue;
if (CGRectContainsPoint(CGRectInset(CCAVisibleModuleFrame(module, overlay), -8.0, -8.0), point)) return 0;
}
}
return 1;
}
if ([objc_getAssociatedObject(gesture, @selector(blankHeld:)) boolValue]) {
if (gEditModeActive || gCCAExpandedModuleOpen) return 0;
UIViewController *overlay = gOverlayControllers.allObjects.firstObject;
CGPoint point = [touch locationInView:overlay.view];
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
if (module.view.hidden || module.view.alpha <= 0.01 || CCAModuleViewIsPageHidden(module.view)) continue;
if (CGRectContainsPoint(CGRectInset(CCAVisibleModuleFrame(module, overlay), -2.0, -2.0), point)) return 0;
}
}
if ([objc_getAssociatedObject(gesture, @selector(modulePanned:)) isEqual:@"overlayPan"]) {
if (!gEditModeActive) return 0;
CGPoint location = [touch locationInView:gesture.view];
if (location.y > gesture.view.bounds.size.height - (92.0>gesture.view.safeAreaInsets.bottom + 68.0?92.0:gesture.view.safeAreaInsets.bottom + 68.0)) return 0;
UIView *touchedView = touch.view;
while (touchedView) {
if (touchedView.tag == kCCAResizeButtonTag || touchedView.tag == kCCARemoveButtonTag) return 0;
...
CGPoint point = [touch locationInView:overlay.view];
if ([self pointHitsEditChrome:point overlay:overlay generous:NO]) return 0;
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
if (module.view.hidden || module.view.alpha <= 0.01 || CCAModuleViewIsPageHidden(module.view)) continue;
CGRect frame = CCAVisibleModuleFrame(module, overlay);
if (CGRectContainsPoint(CGRectInset(frame, -14.0, -14.0), point)) return 1;
}
return 0;
}
...
if (overlayLocation.y > gesture.view.bounds.size.height - (92.0>gesture.view.safeAreaInsets.bottom + 68.0?92.0:gesture.view.safeAreaInsets.bottom + 68.0)) return 0;
if (view.tag == kCCAEditTouchShieldTag) {
UIViewController *overlay = gOverlayControllers.allObjects.firstObject;
CGPoint location = [touch locationInView:overlay.view];
UIButton *addControl = (UIButton *)[overlay.view viewWithTag:kCCAAddControlButtonTag];
if (addControl && !addControl.hidden && CGRectContainsPoint(CGRectInset(addControl.frame, -12.0, -12.0), location)) return 0;
if ([self pointHitsEditChrome:location overlay:overlay generous:YES]) return 0;
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
if (module.view.hidden || module.view.alpha <= 0.01 || CCAModuleViewIsPageHidden(module.view)) continue;
CGRect frame = CCAVisibleModuleFrame(module, overlay);
if (CGRectContainsPoint(CGRectInset(frame, -14.0, -14.0), location)) return 0;
}
return 1;
}
while (view) {
if (view.tag == 181000 || view.tag == kCCARemoveButtonTag || view.tag == kCCAResizeButtonTag) return 0;
if (view.tag == kCCAAddControlButtonTag) return 0;
if (view.tag == kCCAEditShieldTag) return 0;
view = view.superview;
}
return 1;
}
while (view) {
if ([view isKindOfClass:[UIControl class]] || view.tag == 181000) return 0;
view = view.superview;
}
return 1;
}
...
if ([getAss(gesture,kCCAEditDismissPanKey) boolValue] || [getAss(otherGesture,kCCAEditDismissPanKey) boolValue]) return 0;
if (gesture.view.tag == kCCAResizeButtonTag || otherGesture.view.tag == kCCAResizeButtonTag || gCCAResizeInProgress) return 0;
BOOL gestureIsPager = [getAss(gesture,kCCAPagerGestureKey) boolValue];
BOOL otherIsPager = [getAss(otherGesture,kCCAPagerGestureKey) boolValue];
...
if ((gestureIsPager && otherIsModulePan) || (otherIsPager && gestureIsModulePan) || gCCADragInProgress) return 0;
if (gestureIsPager || otherIsPager) return 1;
return 0;
}
- (void)addTapped:(UIButton *)sender { if (!gEnabled || gCCAExpandedModuleOpen) return; CCAHaptic(); [self setEditing:!gEditModeActive]; }
- (void)expandConnectivityFromMiniCluster:(UIButton *)sender {
...
gCCAConnectivityHasProxySourceFrame = gCCAConnectivityProxySourceWindowFrame.size.width > 1.0 &&
gCCAConnectivityProxySourceWindowFrame.size.height > 1.0;
gCCAConnectivityProxyExpansionActive = gCCAConnectivityHasProxySourceFrame;
} else {
gCCAConnectivityProxySourceView = nil;
gCCAConnectivityProxySourceWindowFrame = ((CGRect){{0,0},{0,0}});
...
- (void)connectivityProxyTapped:(UIControl *)sender {
UIControl *nativeControl = getAss(sender,kCCAConnectivityForwardControlKey);
...
if (!gCCAPendingOptimisticCleanups) gCCAPendingOptimisticCleanups = [NSMutableSet set];
[gCCAPendingOptimisticCleanups addObject:identifier];
...
[gCCAConnectivityOptimisticStates removeObjectForKey:identifier];
[gCCAPendingOptimisticCleanups removeObject:identifier];
for (UIViewController *candidateOverlay in gOverlayControllers.allObjects) {
for (UIViewController *module in CCACollectModuleControllers(candidateOverlay)) {
if ([CCAModuleIdentifier(module) isEqualToString:identifier]) CCAConfigureOddResizedModuleLayout(module);
}
...
NSString *identifier = sender ? getAss(sender,kCCAConnectivityIdentifierKey) : nil;
...
- (void)ignoreTap:(UIButton *)sender {}
...
if (gesture.state == UIGestureRecognizerStateBegan) {
CCAHaptic();
[UIView animateWithDuration:0.55 delay:0.0 options:0<<16 | 4<<16 animations:^{
material.alpha = 1.0;
...
[UIView animateWithDuration:0.2 delay:0.0 options:UIViewAnimationOptionCurveEaseOut | 4<<16 animations:^{
material.alpha = 1.0;
button.transform = CGAffineTransformIdentity;
} completion:nil];
}
...
- (void)saveEnabledModuleIdentifiers:(NSArray*)identifiers {
id provider = [self moduleSettingsProvider];
...
NSFontAttributeName: [UIFont systemFontOfSize:12.5 weight:2],
...
NSMutableArray*detachedBorders = [NSMutableArray array];
...
hideView(getAss(overlay,kCCAEditGridKey));
...
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
hideView(getAss(module.view,kCCARemoveButtonKey));
hideView(getAss(module.view,kCCAResizeButtonKey));
...
@"view": border,
@"parent": borderParent,
@"index": @(borderIndex == NSIntegerMax ? borderParent.subviews.count : borderIndex),
}];
[border removeFromSuperview];
}
NSString *identifier = CCAModuleIdentifier(module);
if (identifier.length && module.view.window && !(module.view.bounds.size.width<=0||module.view.bounds.size.height<=0)) {
...
screenImage = [renderer imageWithActions:^(UIGraphicsImageRendererContext *context) {
[screenSnapshot drawViewHierarchyInRect:screenSnapshot.bounds afterScreenUpdates:YES];
}];
}@catch(id e){ screenImage = nil; }
...
NSUInteger index = ([record[@"index"] unsignedIntegerValue]<parent.subviews.count?[record[@"index"] unsignedIntegerValue]:parent.subviews.count);
...
- (NSArray*)availableControlCatalog {
NSArray*enabled = [self enabledModuleIdentifiers];
NSMutableSet*present = [NSMutableSet setWithArray:enabled ?: @[]];
...
@try{ repository = [manager valueForKey:key]; }@catch(id e){}
if (repository) break;
}
...
if (!view) return;
id pageHidden = getAss(view,kCCAPageHiddenKey);
[records addObject:@{
@"view": view,
@"hidden": @(view.hidden),
@"alpha": @(view.alpha),
...
if (pageHidden) setAss(view,kCCAPageHiddenKey, @NO, 1);
};
...
setAss(view,kCCAPageHiddenKey, pageHidden == NSNull.null ? nil : pageHidden, 1);
}
}
- (UIView *)editChromeHostForModuleView:(UIView *)moduleView overlay:(UIViewController *)overlay {
...
- (void)positionEditControlsForModuleView:(UIView *)moduleView overlay:(UIViewController *)overlay overlayFrame:(CGRect)overlayFrame {
if (!moduleView) return;
UIButton *remove = getAss(moduleView,kCCARemoveButtonKey);
UIButton *resize = getAss(moduleView,kCCAResizeButtonKey);
if (remove) {
...
resize.frame = CGRectMake((resizeHostFrame.origin.x+resizeHostFrame.size.width) - 42.0,(resizeHostFrame.origin.y+resizeHostFrame.size.height) - 42.0,42.0,42.0);
}
}
- (BOOL)pointHitsEditChrome:(CGPoint)point overlay:(UIViewController *)overlay generous:(BOOL)generous {
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
if (module.view.hidden || module.view.alpha <= 0.01 || CCAModuleViewIsPageHidden(module.view)) continue;
UIButton *removeChrome = getAss(module.view,kCCARemoveButtonKey);
UIButton *resizeChrome = getAss(module.view,kCCAResizeButtonKey);
if (resizeChrome && !resizeChrome.hidden && resizeChrome.alpha > 0.01 && resizeChrome.userInteractionEnabled && resizeChrome.superview) {
BOOL small = [getAss(resizeChrome,kCCASmallModuleChromeKey) boolValue];
CGRect frame = [resizeChrome.superview convertRect:resizeChrome.frame toView:overlay.view];
CGFloat cornerSize = small ? 26.0 : 34.0;
CGRect hitFrame = CGRectMake((frame.origin.x+frame.size.width) - cornerSize,(frame.origin.y+frame.size.height) - cornerSize,cornerSize,cornerSize);
if (CGRectContainsPoint(hitFrame, point)) return 1;
}
...
if (CGRectContainsPoint(CGRectInset(frame, -10.0, -10.0), point)) return 1;
}
}
return 0;
}
...
layoutSize = (CCUILayoutSize){(4<(NSUInteger?4:(NSUInteger)[width unsignedIntegerValue]), (4<(NSUInteger?4:(NSUInteger)[height unsignedIntegerValue])};
break;
}
}
}
...
UIView *container = [[UIView alloc] initWithFrame:(CGRect){((CGPoint){0,0}), pointSize}];
...
@try{ context = ((id (*)(id, SEL, id))objc_msgSend)([contextClass alloc], contextInit, identifier); }@catch(id e){ context = nil; }
}
if (!context) {
@try{
context = [contextClass new];
[context setValue:identifier forKey:@"moduleIdentifier"];
}@catch(id e){ context = nil; }
}
}
id module = nil;
...
@try{ module = ((id (*)(id, SEL, id))objc_msgSend)([principal alloc], moduleContextInit, context); }@catch(id e){ module = nil; }
}
if (principal && !module) {
@try{ module = [[principal alloc] init]; }@catch(id e){ module = nil; }
}
if (module && context) {
@try{
...
@try{ contentController = ((id (*)(id, SEL))objc_msgSend)(module, NSSelectorFromString(@"contentViewController")); }@catch(id e){ contentController = nil; }
}
UIView *moduleContent = [contentController isKindOfClass:[UIViewController class]] ? contentController.view : nil;
if (moduleContent) {
setAss(container,kCCAAddSheetModuleKey, module, 1);
setAss(container,kCCAAddSheetControllerKey, contentController, 1);
setAss(container,kCCAAddSheetContextKey, context, 1);
...
@try{ [moduleContent layoutIfNeeded]; }@catch(id e){}
NSMutableArray*labelQueue = [NSMutableArray arrayWithObject:moduleContent];
...
if (!CCAModuleIdentifierSupportsOwnedDuplicates(familyIdentifier)) return 0;
NSArray*enabled = [self enabledModuleIdentifiers];
NSMutableSet*present = [NSMutableSet setWithArray:enabled ?: @[]];
[present addObjectsFromArray:[self fixedModuleIdentifiers]];
UIViewController *overlay = gOverlayControllers.allObjects.firstObject;
...
NSArray*origin = gCCACustomOrigins[existing];
if (origin.count >= 2) rect.origin = (CCUILayoutPoint){origin[0].unsignedIntegerValue, origin[1].unsignedIntegerValue};
NSArray*customSize = gCCACustomSizes[existing];
...
NSUInteger startPage = overlay ? CCADerivedVisiblePageForOverlay(overlay) : (gCCACurrentPage<kCCAMaxPages - 1?gCCACurrentPage:kCCAMaxPages - 1);
CCUILayoutPoint destination = {0, 0};
if (!CCAGuaranteedPagedSlot(duplicateIdentifier, size, startPage, layout, &destination)) return 0;
...
[self syncOwnedDuplicateModulesForOverlay:overlay];
[self normalizePagedLayoutForOverlay:overlay];
[self setCurrentPage:gCCAPendingPageAfterRebuild == NSIntegerMax ? gCCACurrentPage : (gCCAPendingPageAfterRebuild<((NSUInteger?gCCAPendingPageAfterRebuild:MAX((NSUInteger)1>gCCAPageCount?(NSUInteger?gCCAPendingPageAfterRebuild:MAX((NSUInteger)1:gCCAPageCount) - 1) forOverlay:overlay animated:NO];
gCCAPendingPageAfterRebuild = NSIntegerMax;
...
if ([self addOwnedDuplicateForIdentifier:identifier]) return 1;
return 0;
}
...
CFPreferencesSetAppValue(CFSTR("ModuleGridSizes"), (__bridge CFPropertyListRef)[gCCACustomSizes copy], kCCAPrefsDomain);
CFPreferencesAppSynchronize(kCCAPrefsDomain);
NSMutableArray*updated = [enabled mutableCopy] ?: [NSMutableArray array];
...
if (sourceIndex == NSIntegerMax || targetIndex == NSIntegerMax || sourceIndex == targetIndex) {
return 0;
}
...
CFPreferencesSetAppValue(CFSTR("ModuleGridSizes"), (__bridge CFPropertyListRef)[gCCACustomSizes copy], kCCAPrefsDomain);
CFPreferencesAppSynchronize(kCCAPrefsDomain);
UIView *moduleView = getAss(sender,kCCARemoveModuleViewKey);
...
UIButton *resizeButton = getAss(moduleView,kCCAResizeButtonKey);
...
UIView *moduleView = getAss(sender,kCCARemoveModuleViewKey);
CGFloat removalRadius = moduleView.layer.cornerRadius > 1.0 ? moduleView.layer.cornerRadius : (moduleView.bounds.size.width<moduleView.bounds.size.height?moduleView.bounds.size.width:moduleView.bounds.size.height) * 0.28;
...
[sender removeFromSuperview];
[resizeButton removeFromSuperview];
objc_setAssociatedObject(moduleView, @selector(applyEditingToModule:editing:), nil, 1);
setAss(moduleView,kCCARemoveButtonKey, nil, 1);
setAss(moduleView,kCCAResizeButtonKey, nil, 1);
[self saveEnabledModuleIdentifiers:updated];
[self resettleAfterCollectionRebuild];
}];
}
...
NSMutableSet*validControls = [NSMutableSet set];
for (UIViewController *candidate in CCACollectModuleControllers(overlay)) {
UIButton *candidateRemove = getAss(candidate.view,kCCARemoveButtonKey);
UIButton *candidateResize = getAss(candidate.view,kCCAResizeButtonKey);
...
CGFloat minimum = (width<height?width:height);
if (minimum <= 0.0) return 0.0;
BOOL isOneByOne = (width - height<0?-(width - height):width - height) <= 3.0 && minimum <= 76.0;
return isOneByOne ? minimum * 0.5 : (32.0<(22.0>minimum * 0.5 - 6.0?32.0:MAX(22.0, minimum * 0.5 - 6.0?22.0:minimum * 0.5 - 6.0?32.0:MAX(22.0, minimum * 0.5 - 6.0));
}
...
CGFloat minimum = (size.width<size.height?size.width:size.height);
CGFloat maximum = (size.width>size.height?size.width:size.height);
...
setAss(presentation,kCCAResizePresentationTransitionKey, @YES, 1);
...
@try{ [filter setValue:@(endRadius) forKey:@"inputRadius"]; }@catch(id e){}
...
setAss(presentation,kCCAResizePresentationTransitionKey, nil, 1);
if (completion) completion();
}];
});
}
- (UIImage *)snapshotForPresentation:(UIView *)presentation {
if (!presentation || (presentation.bounds.size.width<=0||presentation.bounds.size.height<=0)) return nil;
...
DO_ONCE({ context = [CIContext contextWithOptions:@{kCIContextUseSoftwareRenderer: @NO}]; });
...
(void)outgoingFrame;
NSObject *token = [NSObject new];
setAss(presentation,kCCAResizePresentationTransitionKey, token, 1);
...
presentation.alpha = appearing ? 0.0 : 1.0;
[UIView animateWithDuration:0.16 delay:0.0 options:0<<16 | 4<<16 animations:^{
presentation.alpha = appearing ? 1.0 : 0.0;
} completion:^(BOOL finished) {
if (getAss(presentation,kCCAResizePresentationTransitionKey) != token) return;
setAss(presentation,kCCAResizePresentationTransitionKey, nil, 1);
if (completion) completion();
}];
}
...
if (!buttonView) return;
NSArray*previewSize = getAss(buttonView,kCCAResizePresentationSizeOverrideKey);
NSArray*effectiveSize = previewSize.count >= 2 ? previewSize : customSize;
...
!getAss(presentation,kCCAResizePresentationTransitionKey)) {
presentation.alpha = 1.0;
}
if (isPowerModule) {
...
NSMutableArray*queue = [NSMutableArray arrayWithObject:moduleView];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([candidate isKindOfClass:[UIActivityIndicatorView class]]) {
...
if (glyph.bounds.size.width > 72.0 || glyph.bounds.size.height > 72.0) {
CGPoint compactOrigin = [buttonView convertPoint:((CGPoint){0,0}) toView:glyph.superview];
...
if (presentation) setAss(presentation,kCCAResizePresentationLayoutKey, nil, 3);
if (presentation && !getAss(presentation,kCCAResizePresentationTransitionKey)) {
[self transitionResizedPresentation:presentation appearing:NO outgoingSharpImage:nil outgoingImage:nil outgoingFrame:((CGRect){{0,0},{0,0}}) completion:^{ [presentation removeFromSuperview]; }];
}
return;
}
...
NSString *previousLayoutMode = getAss(presentation,kCCAResizePresentationLayoutKey);
...
CGFloat textWidth = presentsAsLargeButton ? (0.0>logicalSize.width - textX - 24.0?0.0:logicalSize.width - textX - 24.0) : (0.0>logicalSize.width - 83.0?0.0:logicalSize.width - 83.0);
CGFloat lineHeight = 14.3333;
...
[UIView performWithoutAnimation:^{
presentation.frame = (CGRect){((CGPoint){0,0}), logicalSize};
...
setAss(presentation,kCCAResizePresentationLayoutKey, layoutMode, 3);
[buttonView bringSubviewToFront:presentation];
if (createdPresentation || snappedLayoutChanged) {
[self transitionResizedPresentation:presentation appearing:YES outgoingSharpImage:nil outgoingImage:nil outgoingFrame:((CGRect){{0,0},{0,0}}) completion:nil];
}
}
- (void)applyRefinedLookToModule:(UIViewController *)module {
UIView *view = module.view;
if (!view) return;
if (!getAss(view,kCCAOriginalCornerRadiusKey)) {
setAss(view,kCCAOriginalCornerRadiusKey, @(view.layer.cornerRadius), 1);
setAss(view,kCCAOriginalMasksToBoundsKey, @(view.layer.masksToBounds), 1);
}
if (gEnabled) {
...
view.layer.cornerRadius = [getAss(view,kCCAOriginalCornerRadiusKey) doubleValue];
view.layer.masksToBounds = [getAss(view,kCCAOriginalMasksToBoundsKey) boolValue];
}
...
if ([[module.class className] isEqualToString:@"CCUIConnectivityModuleViewController"]) connectivity = module;
...
@try{ [contentContainer setValue:@(radius) forKey:@"compactContinuousCornerRadius"]; }@catch(id e){}
NSMutableArray*queue = [NSMutableArray arrayWithObject:moduleView];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
...
BOOL fillsModule = (candidate.bounds.size.width - moduleView.bounds.size.width<0?-(candidate.bounds.size.width - moduleView.bounds.size.width):candidate.bounds.size.width - moduleView.bounds.size.width) < 3.0 &&
(candidate.bounds.size.height - moduleView.bounds.size.height<0?-(candidate.bounds.size.height - moduleView.bounds.size.height):candidate.bounds.size.height - moduleView.bounds.size.height) < 3.0;
...
candidate.view.bounds.size.width < 190.0 &&
candidate.view.bounds.size.height < 190.0) {
...
NSArray*customSize = identifier.length ? gCCACustomSizes[identifier] : nil;
if (customSize.count >= 2) {
layoutSize.width = ((NSUInteger)1>customSize[0].unsignedIntegerValue?(NSUInteger)1:customSize[0].unsignedIntegerValue);
layoutSize.height = ((NSUInteger)1>customSize[1].unsignedIntegerValue?(NSUInteger)1:customSize[1].unsignedIntegerValue);
}
...
- (void)applyLivePreviewOrder:(NSArray*)order overlay:(UIViewController *)overlay {
...
NSMutableArray*sizes = [NSMutableArray arrayWithCapacity:order.count];
for (NSString *identifier in order) {
...
CCUILayoutSize size = {
(1>(NSUInteger?1:(NSUInteger)llround((match.view.bounds.size.width + kCCAGridGap) / step)),
(1>(NSUInteger?1:(NSUInteger)llround((match.view.bounds.size.height + kCCAGridGap) / step))
};
...
[collection.view setNeedsLayout];
[UIView animateWithDuration:0.20 delay:0.0 options:0<<16 | 4<<16 animations:^{
...
if ((firstFrame.size.width<=0||firstFrame.size.height<=0)) continue;
...
if (!CGRectIsNull(intersection) && intersection.size.width > 4.0 && intersection.size.height > 4.0) return 1;
}
}
return 0;
}
...
NSMutableDictionary*proposed = CCACurrentPageLayout(overlay, kCCAMinimumGridRows);
...
if (!proposed[sourceID] || !proposed[targetID]) return 0;
...
if (!CCALogicalLayoutIsLegal(proposed, kCCAMinimumGridRows)) return 0;
NSArray*identifiers = proposed.allKeys;
for (NSUInteger first = 0; first < identifiers.count; first++) {
CCUILayoutRect a = {}; [proposed[identifiers[first]] getValue:&a];
if (a.origin.x + a.size.width > 4) return 0;
for (NSUInteger second = first + 1; second < identifiers.count; second++) {
...
NSMutableDictionary*proposed = CCALayoutForPage(overlay, page, kCCAMinimumGridRows);
...
[sourceValue getValue:&sourceRect];
NSArray*savedSize = gCCACustomSizes[sourceID];
if (savedSize.count >= 2) sourceRect.size = (CCUILayoutSize){savedSize[0].unsignedIntegerValue, savedSize[1].unsignedIntegerValue};
}
if (sourceWasOnTargetPage && sourceRect.origin.x == destination.x && sourceRect.origin.y == destination.y) return 0;
sourceRect.origin = destination;
if (sourceRect.origin.x + sourceRect.size.width > 4 || sourceRect.origin.y + sourceRect.size.height > kCCAMinimumGridRows) return 0;
proposed[sourceID] = [NSValue value:&sourceRect withObjCType:@encode(CCUILayoutRect)];
if (!CCALogicalLayoutIsLegal(proposed, kCCAMinimumGridRows)) return 0;
NSArray*identifiers = proposed.allKeys;
for (NSUInteger first = 0; first < identifiers.count; first++) {
...
- (BOOL)applyExplicitGridInsertionFrom:(NSString *)sourceID toOrigin:(CCUILayoutPoint)destination onPage:(NSUInteger)page maxRows:(NSUInteger)maxRows overlay:(UIViewController *)overlay {
NSValue *sourceValue = gCCANativeLayoutRects[sourceID];
if (!sourceValue || maxRows == 0) return 0;
NSMutableDictionary*initial = CCALayoutForPage(overlay, page, maxRows);
NSMutableDictionary*proposed = [initial mutableCopy];
CCUILayoutRect sourceRect = {};
...
sourceRect.origin = destination;
if (sourceRect.origin.x + sourceRect.size.width > 4 || sourceRect.origin.y + sourceRect.size.height > maxRows) return 0;
proposed[sourceID] = [NSValue value:&sourceRect withObjCType:@encode(CCUILayoutRect)];
NSMutableArray*remaining = [proposed.allKeys mutableCopy];
...
NSMutableArray*placed = [NSMutableArray arrayWithObject:sourceID];
...
if (xOverlap && yOverlap) requiredY = (requiredY>blocker.origin.y + blocker.size.height?requiredY:blocker.origin.y + blocker.size.height);
}
if (requiredY != candidate.origin.y) {
candidate.origin.y = requiredY;
adjusted = YES;
displacedAny = YES;
if (candidate.origin.y + candidate.size.height > maxRows) return 0;
}
}
proposed[identifier] = [NSValue value:&candidate withObjCType:@encode(CCUILayoutRect)];
[placed addObject:identifier];
}
if (!displacedAny) return 0;
if (!CCALogicalLayoutIsLegal(proposed, maxRows)) return 0;
...
if (!identifier.length || [identifier isEqualToString:@"com.apple.control-center.DisplayModule"] || [identifier isEqualToString:@"com.apple.mediaremote.controlcenter.audio"] || [identifier isEqualToString:@"com.apple.control-center.ConnectivityModule"]) return 0;
if ([identifier.lowercaseString containsString:@"ccaster.connectivity"]) return 1;
NSValue *baseValue = gCCABaseLayoutSizes[identifier];
...
NSMutableArray*placed = [NSMutableArray arrayWithObject:sourceID];
NSMutableDictionary*overflowOrigins = [NSMutableDictionary dictionary];
NSMutableDictionary*globalOccupied = [NSMutableDictionary dictionary];
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
NSString *identifier = CCAModuleIdentifier(module);
NSValue *nativeRect = identifier.length ? gCCANativeLayoutRects[identifier] : nil;
...
if (!CCAFindPagedSlot(identifier, candidate.size, gCCACurrentPage + 1, globalOccupied, &overflowDestination)) return 0;
...
UIViewController *collection = [self moduleCollectionControllerInOverlay:overlay];
[collection.view setNeedsLayout];
[UIView animateWithDuration:0.24 animations:^{ [collection.view layoutIfNeeded]; } completion:^(BOOL finished) {
for (UIViewController *candidate in CCACollectModuleControllers(overlay)) [self applyEditingToModule:candidate editing:YES];
if (gEditModeActive) {
[self prepareGridForOverlay:overlay collection:collection];
NSMutableDictionary*pageGrids = getAss(overlay,kCCAEditPageGridsKey);
...
for (UIViewController *candidate in CCACollectModuleControllers(overlay)) {
UIButton *remove = getAss(candidate.view,kCCARemoveButtonKey);
UIButton *resize = getAss(candidate.view,kCCAResizeButtonKey);
...
NSArray*saved = gCCACustomSizes[identifier];
...
CGFloat width = (fourCellSize<(twoCellSize>startFrame.size.width + translation.x?fourCellSize:MAX(twoCellSize, startFrame.size.width + translation.x?twoCellSize:startFrame.size.width + translation.x?fourCellSize:MAX(twoCellSize, startFrame.size.width + translation.x));
CGFloat minimumHeight = width >= (twoCellSize + fourCellSize) * 0.5 ? kCCAGridCellSize : twoCellSize;
CGFloat height = (fourCellSize<(minimumHeight>startFrame.size.height + translation.y?fourCellSize:MAX(minimumHeight, startFrame.size.height + translation.y?minimumHeight:startFrame.size.height + translation.y?fourCellSize:MAX(minimumHeight, startFrame.size.height + translation.y));
frame.size = CGSizeMake(width,height);
return frame;
}
if (base.width == 1 && base.height == 1) {
CGFloat twoCellSize = kCCAGridCellSize * 2.0 + kCCAGridGap;
CGFloat width = (twoCellSize<(kCCAGridCellSize>startFrame.size.width + translation.x?twoCellSize:MAX(kCCAGridCellSize, startFrame.size.width + translation.x?kCCAGridCellSize:startFrame.size.width + translation.x?twoCellSize:MAX(kCCAGridCellSize, startFrame.size.width + translation.x));
CGFloat height = (twoCellSize<(kCCAGridCellSize>startFrame.size.height + translation.y?twoCellSize:MAX(kCCAGridCellSize, startFrame.size.height + translation.y?kCCAGridCellSize:startFrame.size.height + translation.y?twoCellSize:MAX(kCCAGridCellSize, startFrame.size.height + translation.y));
if (start.height == 1 && height > kCCAGridCellSize) width = (width>height?width:height);
if (start.width == 2 && height > kCCAGridCellSize) width = twoCellSize;
frame.size = CGSizeMake(width,height);
} else if (base.width == 2 && base.height == 2) {
CGFloat twoCellSize = kCCAGridCellSize * 2.0 + kCCAGridGap;
CGFloat fourCellSize = kCCAGridCellSize * 4.0 + kCCAGridGap * 3.0;
frame.size = CGSizeMake((fourCellSize<(twoCellSize>startFrame.size.width + translation.x?fourCellSize:MAX(twoCellSize, startFrame.size.width + translation.x?twoCellSize:startFrame.size.width + translation.x?fourCellSize:MAX(twoCellSize, startFrame.size.width + translation.x)), twoCellSize);
}
return frame;
}
...
setAss(gesture,kCCAResizeStartSizeKey, startValue, 1);
setAss(gesture,kCCAResizeCandidateSizeKey, startValue, 1);
UIView *moduleView = getAss(handle,kCCARemoveModuleViewKey);
...
setAss(gesture,kCCAResizeSuppressedGesturesKey, suppressed, 1);
}
if (moduleView) {
CGRect startFrame = CGRectMake(moduleView.frame.origin.x,moduleView.frame.origin.y,moduleView.bounds.size.width,moduleView.bounds.size.height);
setAss(gesture,kCCAResizePreviewStartFrameKey, [NSValue valueWithCGRect:startFrame], 1);
UIView *buttonView = CCAFindSubviewWithClassName(moduleView, @"CCUIButtonModuleView");
UIView *overrideHost = buttonView ?: moduleView;
if (overrideHost) {
setAss(overrideHost,kCCAResizePreviewKey, @YES, 1);
setAss(overrideHost,kCCAResizePresentationSizeOverrideKey, @[@(start.width), @(start.height)], 1);
}
}
...
[getAss(gesture,kCCAResizeStartSizeKey) getValue:&start];
UIView *moduleView = getAss(handle,kCCARemoveModuleViewKey);
CGRect startFrame = [getAss(gesture,kCCAResizePreviewStartFrameKey) CGRectValue];
...
if (moduleView && wrapper && !(startFrame.size.width<=0||startFrame.size.height<=0)) {
...
handle.frame = CGRectMake((handleFrame.origin.x+handleFrame.size.width) - 42.0,(handleFrame.origin.y+handleFrame.size.height) - 42.0,42.0,42.0);
...
NSValue *priorValue = getAss(gesture,kCCAResizeCandidateSizeKey);
CCUILayoutSize prior = {};
[priorValue getValue:&prior];
if (candidate.width != prior.width || candidate.height != prior.height) {
setAss(gesture,kCCAResizeCandidateSizeKey, [NSValue value:&candidate withObjCType:@encode(CCUILayoutSize)], 1);
UIView *buttonView = CCAFindSubviewWithClassName(moduleView, @"CCUIButtonModuleView");
UIView *overrideHost = buttonView ?: moduleView;
if (overrideHost) setAss(overrideHost,kCCAResizePresentationSizeOverrideKey, @[@(candidate.width), @(candidate.height)], 1);
...
setAss(commitOverrideHost,kCCAResizePreviewKey, nil, 1);
setAss(commitOverrideHost,kCCAResizePresentationSizeOverrideKey, nil, 1);
}
CGRect endpointFrame = startFrame;
endpointFrame.size = CGSizeMake(kCCAGridCellSize + (candidate.width - 1) * kCCAGridStep,kCCAGridCellSize + (candidate.height - 1) * kCCAGridStep);
UIVisualEffectView *border = objc_getAssociatedObject(moduleView, @selector(applyEditingToModule:editing:));
[UIView animateWithDuration:0.24 delay:0.0 options:0<<16 | 4<<16 animations:^{
...
NSArray*suppressedGestures = getAss(gesture,kCCAResizeSuppressedGesturesKey);
for (UIGestureRecognizer *suppressed in suppressedGestures) suppressed.enabled = YES;
setAss(gesture,kCCAResizeSuppressedGesturesKey, nil, 1);
UIView *finishOverrideHost = buttonView ?: moduleView;
if (finishOverrideHost) {
setAss(finishOverrideHost,kCCAResizePreviewKey, nil, 1);
setAss(finishOverrideHost,kCCAResizePresentationSizeOverrideKey, nil, 1);
}
[self clearEditGridLandingRectsForOverlay:overlay];
if (moduleView && !committed && !(startFrame.size.width<=0||startFrame.size.height<=0)) {
...
setAss(gesture,kCCAResizeStartSizeKey, nil, 1);
setAss(gesture,kCCAResizeCandidateSizeKey, nil, 1);
setAss(gesture,kCCAResizePreviewStartFrameKey, nil, 1);
}
}
...
CGPoint startPoint = [getAss(gesture,kCCADragStartPointKey) CGPointValue];
...
objc_setAssociatedObject(gesture, @selector(moduleControllerForShield:), moduleView, 1);
objc_setAssociatedObject(gesture, @selector(modulePanned:), sourceID, 3);
setAss(gesture,kCCADragStartPointKey, [NSValue valueWithCGPoint:location], 1);
CGRect visibleSourceFrame = CCAVisibleModuleFrame(source, overlay);
CGPoint grabOffset = CGPointMake(location.x - visibleSourceFrame.origin.x,location.y - visibleSourceFrame.origin.y);
setAss(gesture,kCCADragGrabOffsetKey, [NSValue valueWithCGPoint:grabOffset], 1);
setAss(gesture,kCCADragMovedKey, @NO, 1);
NSArray *baseOrder = gCCAProviderOrder.count ? gCCAProviderOrder : [self enabledModuleIdentifiers];
setAss(gesture,kCCADragBaseOrderKey, [baseOrder copy], 1);
UIView *proxy = [[UIView alloc] initWithFrame:CCAVisibleModuleFrame(source, overlay)];
proxy.bounds = (CGRect){((CGPoint){0,0}), moduleView.bounds.size};
...
if (!proxyContent) proxyContent = [moduleView resizableSnapshotViewFromRect:moduleView.bounds afterScreenUpdates:YES withCapInsets:((UIEdgeInsets){0,0,0,0})];
...
[proxyRing appendPath:[UIBezierPath bezierPathWithRoundedRect:CGRectInset(proxyBorder.bounds, 3.5, 3.5) cornerRadius:(0.0>proxyRadius - 3.5?0.0:proxyRadius - 3.5)]];
...
UIButton *sourceRemove = getAss(moduleView,kCCARemoveButtonKey);
UIButton *sourceResize = getAss(moduleView,kCCAResizeButtonKey);
...
if (!fallbackSnapshot) fallbackSnapshot = [chromeButton resizableSnapshotViewFromRect:chromeButton.bounds afterScreenUpdates:NO withCapInsets:((UIEdgeInsets){0,0,0,0})];
...
[overlay.view addSubview:proxy];
setAss(gesture,kCCADragProxyKey, proxy, 1);
setAss(gesture,kCCADragProxyStartFrameKey, [NSValue valueWithCGRect:proxy.frame], 1);
NSMutableDictionary*baseFrames = [NSMutableDictionary dictionary];
for (UIViewController *candidate in CCACollectModuleControllers(overlay)) {
...
setAss(gesture,kCCADragBaseFramesKey, baseFrames, 1);
...
setAss(gesture,kCCADragStartPageKey, @(sourcePage), 1);
CCAEditGridView *grid = [self editGridForPage:sourcePage overlay:overlay];
if (!grid) grid = getAss(overlay,kCCAEditGridKey);
...
startFrame = CGRectMake(slot.origin.x,slot.origin.y,kCCAGridCellSize + (sourceLogical.size.width - 1) * kCCAGridStep,kCCAGridCellSize + (sourceLogical.size.height - 1) * kCCAGridStep);
}
}
setAss(gesture,kCCADragStartFrameKey, [NSValue valueWithCGRect:startFrame], 1);
NSMutableArray*remainingOccupied = [NSMutableArray array];
...
UIButton *remove = getAss(moduleView,kCCARemoveButtonKey);
UIButton *resize = getAss(moduleView,kCCAResizeButtonKey);
NSMutableArray*hiddenChrome = [NSMutableArray array];
...
setAss(gesture,kCCADragHiddenChromeKey, hiddenChrome, 1);
...
if (moved) setAss(gesture,kCCADragMovedKey, @YES, 1);
UIView *proxy = getAss(gesture,kCCADragProxyKey);
...
CGRect proxyStartFrame = [getAss(gesture,kCCADragProxyStartFrameKey) CGRectValue];
CGRect draggedFrame = CGRectOffset(proxyStartFrame, translation.x, translation.y);
NSUInteger dragPage = (gCCACurrentPage<gCCAPageCount ? gCCAPageCount - 1 : 0?gCCACurrentPage:gCCAPageCount ? gCCAPageCount - 1 : 0);
setAss(gesture,kCCADragStartPageKey, @(dragPage), 1);
...
CGFloat dwellMargin = (18.0>kCCAGridGap + 8.0?18.0:kCCAGridGap + 8.0);
NSInteger dwellDirection = 0;
if (pointInGrid.y < gridBounds.origin.y - dwellMargin && gCCACurrentPage > 0) dwellDirection = -1;
else if (pointInGrid.y > (gridBounds.origin.y+gridBounds.size.height) + dwellMargin && gCCACurrentPage + 1 < gCCAPageCount) dwellDirection = 1;
if (dwellDirection != 0) {
NSNumber *storedDirection = getAss(gesture,kCCADragEdgeDwellDirectionKey);
NSNumber *dwellStart = getAss(gesture,kCCADragEdgeDwellKey);
if (!dwellStart || storedDirection.integerValue != dwellDirection) {
setAss(gesture,kCCADragEdgeDwellKey, @(CACurrentMediaTime()), 1);
setAss(gesture,kCCADragEdgeDwellDirectionKey, @(dwellDirection), 1);
} else if (CACurrentMediaTime() - dwellStart.doubleValue > 0.72) {
setAss(gesture,kCCADragEdgeDwellKey, nil, 1);
setAss(gesture,kCCADragEdgeDwellDirectionKey, nil, 1);
...
setAss(gesture,kCCADragStartPageKey, @(targetPage), 1);
setAss(gesture,kCCADragLandingOriginKey, nil, 1);
setAss(gesture,kCCADragPreviewTargetIDKey, nil, 3);
setAss(gesture,kCCADragPendingTargetIDKey, nil, 3);
}
} else {
setAss(gesture,kCCADragEdgeDwellKey, nil, 1);
setAss(gesture,kCCADragEdgeDwellDirectionKey, nil, 1);
...
CGRect startFrame = [getAss(gesture,kCCADragStartFrameKey) CGRectValue];
CGPoint grabOffset = [getAss(gesture,kCCADragGrabOffsetKey) CGPointValue];
...
NSUInteger nearestSlot = NSIntegerMax;
CGFloat nearestSlotDistance = CGFLOAT_MAX;
NSUInteger footprintColumns = (1>(NSUInteger?1:(NSUInteger)llround((startFrame.size.width + kCCAGridGap) / kCCAGridStep));
NSUInteger footprintRows = (1>(NSUInteger?1:(NSUInteger)llround((startFrame.size.height + kCCAGridGap) / kCCAGridStep));
...
CGFloat distance = hypot(slot.origin.x - proposed.origin.x, slot.origin.y - proposed.origin.y);
if (distance < nearestSlotDistance) { nearestSlotDistance = distance; nearestSlot = index; }
}
if (moved && nearestSlot != NSIntegerMax && grid.columns > 0) {
NSUInteger landingColumn = nearestSlot % grid.columns;
NSUInteger landingRow = nearestSlot / grid.columns;
setAss(gesture,kCCADragLandingOriginKey, @[@(landingColumn), @(landingRow)], 1);
NSMutableArray*snappedLanding = [NSMutableArray array];
...
NSDictionary*baseFrames = getAss(gesture,kCCADragBaseFramesKey);
for (UIViewController *candidate in CCACollectModuleControllers(overlay)) {
NSString *candidateID = CCAModuleIdentifier(candidate);
if ([candidateID isEqualToString:sourceID]) continue;
CGRect candidateFrame = [baseFrames[candidateID] CGRectValue];
if ((candidateFrame.size.width<=0||candidateFrame.size.height<=0)) continue;
CGRect intersection = CGRectIntersection(draggedFrame, candidateFrame);
CGFloat overlap = CGRectIsNull(intersection) ? 0.0 : intersection.size.width * intersection.size.height;
CGFloat requiredOverlap = (draggedFrame.size.width * draggedFrame.size.height<candidateFrame.size.width * candidateFrame.size.height?draggedFrame.size.width * draggedFrame.size.height:candidateFrame.size.width * candidateFrame.size.height) * 0.18;
CGFloat distance = hypot(CGRectGetMidX(candidateFrame) - previewCenter.x, CGRectGetMidY(candidateFrame) - previewCenter.y);
if (moved && overlap >= requiredOverlap && (overlap > bestOverlap + 1.0 || ((overlap - bestOverlap<0?-(overlap - bestOverlap):overlap - bestOverlap) <= 1.0 && distance < previewDistance))) {
bestOverlap = overlap;
...
NSString *previousTargetID = getAss(gesture,kCCADragPreviewTargetIDKey);
NSString *pendingTargetID = getAss(gesture,kCCADragPendingTargetIDKey);
BOOL previewLocked = [getAss(gesture,kCCADragPreviewLockedKey) boolValue];
...
[self applyLivePreviewOrder:getAss(gesture,kCCADragBaseOrderKey) overlay:overlay];
}
}
...
setAss(gesture,kCCADragPendingTargetIDKey, previewTargetID, 3);
NSString *candidateTargetID = [previewTargetID copy];
dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.06 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
NSString *stillPending = getAss(gesture,kCCADragPendingTargetIDKey);
if (gesture.state != UIGestureRecognizerStateChanged || ![stillPending isEqualToString:candidateTargetID]) return;
NSMutableArray *previewOrder = [getAss(gesture,kCCADragBaseOrderKey) mutableCopy];
...
if (sourceIndex == NSIntegerMax || targetIndex == NSIntegerMax) return;
[previewOrder exchangeObjectAtIndex:sourceIndex withObjectAtIndex:targetIndex];
setAss(gesture,kCCADragPreviewTargetIDKey, candidateTargetID, 3);
setAss(gesture,kCCADragPreviewLockedKey, @YES, 1);
[self applyLivePreviewOrder:previewOrder overlay:overlay];
dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.22 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
NSString *committedTarget = getAss(gesture,kCCADragPreviewTargetIDKey);
...
setAss(gesture,kCCADragPreviewLockedKey, @NO, 1);
});
});
}
...
CCAEditGridView *grid = [self editGridForPage:dragPage overlay:overlay];
if (!grid) grid = getAss(overlay,kCCAEditGridKey);
UIView *previewTarget = getAss(gesture,kCCADragPreviewTargetKey);
BOOL moved = [getAss(gesture,kCCADragMovedKey) boolValue];
...
UIButton *removeButton = getAss(moduleView,kCCARemoveButtonKey);
if (removeButton) {
CGPoint startPoint = [getAss(gesture,kCCADragStartPointKey) CGPointValue];
...
if (!CGRectIsNull(sourceFrame) && !(sourceFrame.size.width<=0||sourceFrame.size.height<=0)) {
CGFloat cornerDistance = hypot(startPoint.x - sourceFrame.origin.x, startPoint.y - sourceFrame.origin.y);
...
if (moved) {
targetID = getAss(gesture,kCCADragPendingTargetIDKey);
if (!targetID.length) targetID = getAss(gesture,kCCADragPreviewTargetIDKey);
}
NSMutableArray *order = [getAss(gesture,kCCADragBaseOrderKey) mutableCopy];
...
BOOL didSwap = sourceIndex != NSIntegerMax && targetIndex != NSIntegerMax && sourceIndex != targetIndex;
NSArray*landingOrigin = moved ? getAss(gesture,kCCADragLandingOriginKey) : nil;
...
NSArray*hiddenChrome = getAss(gesture,kCCADragHiddenChromeKey);
...
previewTarget.transform = CGAffineTransformIdentity;
} completion:^(BOOL finished) { finishSource(); }];
}
UIView *dragProxy = getAss(gesture,kCCADragProxyKey);
...
[UIView animateWithDuration:0.20 animations:^{ dragProxy.transform = CGAffineTransformIdentity; } completion:^(BOOL finished) {
moduleView.alpha = 1.0;
UIVisualEffectView *dragBorder = objc_getAssociatedObject(moduleView, @selector(applyEditingToModule:editing:));
...
dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(delay.doubleValue * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
NSMutableSet*validButtons = [NSMutableSet set];
for (UIViewController *candidate in CCACollectModuleControllers(overlay)) {
...
[self clearEditGridLandingRectsForOverlay:overlay];
CGRect originalFrame = [getAss(gesture,kCCADragStartFrameKey) CGRectValue];
if (!didSwap && !didBlankMove && !(originalFrame.size.width<=0||originalFrame.size.height<=0)) grid.occupiedRects = [grid.occupiedRects arrayByAddingObject:[NSValue valueWithCGRect:originalFrame]];
[grid setNeedsDisplay];
objc_setAssociatedObject(gesture, @selector(moduleControllerForShield:), nil, 1);
objc_setAssociatedObject(gesture, @selector(modulePanned:), @"overlayPan", 3);
setAss(gesture,kCCADragStartFrameKey, nil, 1);
setAss(gesture,kCCADragStartPointKey, nil, 1);
setAss(gesture,kCCADragPreviewTargetKey, nil, 1);
setAss(gesture,kCCADragProxyKey, nil, 1);
setAss(gesture,kCCADragBaseOrderKey, nil, 1);
setAss(gesture,kCCADragPreviewTargetIDKey, nil, 1);
setAss(gesture,kCCADragProxyStartFrameKey, nil, 1);
setAss(gesture,kCCADragBaseFramesKey, nil, 1);
setAss(gesture,kCCADragPendingTargetIDKey, nil, 3);
setAss(gesture,kCCADragPreviewLockedKey, nil, 1);
setAss(gesture,kCCADragGrabOffsetKey, nil, 1);
setAss(gesture,kCCADragLandingOriginKey, nil, 1);
setAss(gesture,kCCADragStartPageKey, nil, 1);
setAss(gesture,kCCADragEdgeDwellKey, nil, 1);
setAss(gesture,kCCADragEdgeDwellDirectionKey, nil, 1);
setAss(gesture,kCCADragMovedKey, nil, 1);
setAss(gesture,kCCADragHiddenChromeKey, nil, 1);
...
UIButton *remove = getAss(view,kCCARemoveButtonKey);
UIButton *resize = getAss(view,kCCAResizeButtonKey);
...
objc_setAssociatedObject(view, @selector(applyEditingToModule:editing:), border, 1);
}
...
if (!ownsLiveResize) {
CGRect stableModuleFrame = CGRectMake(view.frame.origin.x,view.frame.origin.y,view.bounds.size.width,view.bounds.size.height);
...
objc_setAssociatedObject(resize, @selector(resizePanned:), moduleIdentifier, 3);
setAss(resize,kCCARemoveModuleViewKey, view, 1);
setAss(view,kCCAResizeButtonKey, resize, 1);
...
setAss(resize,kCCASmallModuleChromeKey,
@((view.bounds.size.width<view.bounds.size.height?view.bounds.size.width:view.bounds.size.height) < 100.0), 1);
resize.hidden = NO;
resize.alpha = 1.0;
...
objc_setAssociatedObject(remove, @selector(removeTapped:), identifier, 3);
setAss(remove,kCCARemoveModuleViewKey, view, 1);
setAss(view,kCCARemoveButtonKey, remove, 1);
...
if (identifier.length) objc_setAssociatedObject(remove, @selector(removeTapped:), identifier, 3);
setAss(remove,kCCARemoveModuleViewKey, view, 1);
remove.userInteractionEnabled = NO;
CGRect moduleFrame = [view convertRect:view.bounds toView:overlay.view];
[self positionEditControlsForModuleView:view overlay:overlay overlayFrame:moduleFrame];
setAss(remove,kCCASmallModuleChromeKey,
@((view.bounds.size.width<view.bounds.size.height?view.bounds.size.width:view.bounds.size.height) < 100.0), 1);
...
- (void)collectEnabledNativeEditingGesturesFromView:(UIView *)view into:(NSMutableArray*)gestures {
for (UIGestureRecognizer *gesture in view.gestureRecognizers) {
NSString *gestureName = [gesture.class className];
...
if (blocksEditing && gesture.enabled && !getAss(gesture,kCCAOwnGestureKey)) {
...
for (UIGestureRecognizer *gesture in view.gestureRecognizers) {
if ([getAss(gesture,kCCADisabledGesturesKey) boolValue]) {
gesture.enabled = YES;
setAss(gesture,kCCADisabledGesturesKey, nil, 1);
}
}
...
setAss(gesture,kCCADisabledGesturesKey, @YES, 1);
gesture.enabled = NO;
}
setAss(overlay,kCCADisabledGesturesKey, disabled, 1);
} else {
NSArray*disabled = getAss(overlay,kCCADisabledGesturesKey);
for (UIGestureRecognizer *gesture in disabled) gesture.enabled = YES;
[self restoreCCAsterDisabledGesturesFromView:overlay.view];
setAss(overlay,kCCADisabledGesturesKey, nil, 1);
}
}
- (NSArray*)chromeViewsInOverlay:(UIViewController *)overlay excludingCollection:(UIViewController *)collection {
...
NSMutableArray*queue = [NSMutableArray arrayWithArray:overlay.view.subviews];
while (queue.count) {
UIView *view = queue.firstObject;
[queue removeObjectAtIndex:0];
NSString *name = [view.class className];
...
if (!overlay) return;
UIViewController *collection = [self moduleCollectionControllerInOverlay:overlay];
NSMutableArray*headerViews = [[self chromeViewsInOverlay:overlay excludingCollection:collection] mutableCopy];
[headerViews filterUsingPredicate:[NSPredicate predicateWithBlock:^BOOL(UIView *view, NSDictionary *bindings) {
...
CGFloat restingAlpha = [getAss(view,kCCAOriginalAlphaKey) doubleValue];
...
if (!getAss(view,kCCAOriginalTransformKey)) {
setAss(view,kCCAOriginalTransformKey, [NSValue valueWithCGAffineTransform:view.transform], 1);
setAss(view,kCCAOriginalAlphaKey, @(view.alpha), 1);
}
if (!getAss(view,kCCAOriginalSublayerTransformKey)) {
setAss(view,kCCAOriginalSublayerTransformKey, [NSValue valueWithCATransform3D:view.layer.sublayerTransform], 1);
}
}
- (CCAEditGridView *)editGridForPage:(NSUInteger)page overlay:(UIViewController *)overlay {
NSMutableDictionary*pageGrids = getAss(overlay,kCCAEditPageGridsKey);
CCAEditGridView *grid = pageGrids[@(page)];
if (!grid && page == gCCACurrentPage) grid = getAss(overlay,kCCAEditGridKey);
return grid;
}
- (void)clearEditGridLandingRectsForOverlay:(UIViewController *)overlay {
NSMutableDictionary*pageGrids = getAss(overlay,kCCAEditPageGridsKey);
for (CCAEditGridView *grid in pageGrids.allValues) grid.landingRects = @[];
CCAEditGridView *currentGrid = getAss(overlay,kCCAEditGridKey);
...
setAss(overlay,kCCAEditPageGridsKey, pageGrids, 1);
}
UIView *gridStack = getAss(overlay,kCCAEditGridStackKey);
if (!gridStack) {
...
setAss(overlay,kCCAEditGridStackKey, gridStack, 1);
}
...
gridStack.layer.sublayerTransform = CATransform3DIdentity;
NSArray*modules = CCACollectModuleControllers(overlay);
NSMutableDictionary*occupiedIndexesByPage = [NSMutableDictionary dictionary];
NSMutableDictionary*baseByPage = [NSMutableDictionary dictionary];
...
CGFloat baseX = frame.origin.x - logical.origin.x * kCCAGridStep;
CGFloat baseY = frame.origin.y - localRow * kCCAGridStep - ((CGFloat)((NSInteger)page - (NSInteger)gCCACurrentPage) * span) - gCCAPagerInteractiveTranslation;
fallbackBase.x = (fallbackBase.x<baseX?fallbackBase.x:baseX);
fallbackBase.y = (fallbackBase.y<baseY?fallbackBase.y:baseY);
...
pageBase.x = (pageBase.x<baseX?pageBase.x:baseX);
pageBase.y = (pageBase.y<baseY?pageBase.y:baseY);
baseByPage[pageKey] = [NSValue valueWithCGPoint:pageBase];
}
NSValue *cachedBaseValue = getAss(overlay,kCCAEditGridBaseOriginKey);
...
setAss(overlay,kCCAEditGridBaseOriginKey, currentBaseValue, 1);
} else if (!cachedBaseValue && fallbackBase.x != CGFLOAT_MAX && fallbackBase.y != CGFLOAT_MAX) {
cachedBase = fallbackBase;
setAss(overlay,kCCAEditGridBaseOriginKey, [NSValue valueWithCGPoint:fallbackBase], 1);
}
...
grid.frame = CGRectMake(0.0,(CGFloat)page * span,gridStack.bounds.size.width,gridStack.bounds.size.height);
...
if ((slot.origin.x+slot.size.width) <= grid.bounds.size.width + 1.0 && (slot.origin.y+slot.size.height) <= grid.bounds.size.height + 1.0) [slots addObject:[NSValue valueWithCGRect:slot]];
}
}
NSMutableArray*occupied = [NSMutableArray array];
NSMutableIndexSet *occupiedIndexes = occupiedIndexesByPage[pageKey];
[occupiedIndexes enumerateIndexesUsingBlock:^(NSUInteger index, BOOL *stop) {
...
setAss(overlay,kCCAEditGridKey, currentGrid, 1);
[self updateEditPageGridTransformsForOverlay:overlay];
return currentGrid;
}
- (void)setEditPresentation:(BOOL)editing forOverlay:(UIViewController *)overlay animated:(BOOL)animated {
...
setAss(shieldTap,kCCAOwnGestureKey, @YES, 1);
objc_setAssociatedObject(shieldTap, @selector(editShieldTapped:), @YES, 1);
...
NSMutableArray*moduleWrappers = [NSMutableArray array];
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
...
NSArray*chromeViews = [self chromeViewsInOverlay:overlay excludingCollection:collection];
...
CGAffineTransform base = [getAss(view,kCCAOriginalTransformKey) CGAffineTransformValue];
view.transform = editing ? CGAffineTransformTranslate(base, 0.0, -22.0) : base;
view.alpha = editing ? 0.0 : [getAss(view,kCCAOriginalAlphaKey) doubleValue];
}
};
void (^completion)(BOOL) = ^(BOOL finished) {
if (editing) {
[self prepareGridForOverlay:overlay collection:collection];
NSMutableDictionary*finalPageGrids = getAss(overlay,kCCAEditPageGridsKey);
...
NSMutableDictionary*oldPageGrids = getAss(overlay,kCCAEditPageGridsKey);
for (CCAEditGridView *pageGrid in oldPageGrids.allValues) [pageGrid removeFromSuperview];
[oldPageGrids removeAllObjects];
UIView *oldGridStack = getAss(overlay,kCCAEditGridStackKey);
[oldGridStack removeFromSuperview];
setAss(overlay,kCCAEditGridStackKey, nil, 1);
setAss(overlay,kCCAEditGridKey, nil, 1);
[self applyPageTransformToOverlay:overlay animated:NO];
[self updatePagedModuleVisibilityForOverlay:overlay showAdjacent:NO];
dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.12 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
if (!gEditModeActive && (gCCAPagerInteractiveTranslation<0?-(gCCAPagerInteractiveTranslation):gCCAPagerInteractiveTranslation) < 0.01) {
[self applyPageTransformToOverlay:overlay animated:NO];
[self updatePagedModuleVisibilityForOverlay:overlay showAdjacent:NO];
}
});
...
if (animated) [UIView animateWithDuration:0.28 delay:0.0 options:0<<16 | 4<<16 animations:changes completion:completion];
...
CGSize size = CGSizeMake(addControl.bounds.size.width,30.0);
CGRect bounds = overlay.view.bounds;
CGFloat bottomInset = (overlay.view.safeAreaInsets.bottom - 14.0>16.0?overlay.view.safeAreaInsets.bottom - 14.0:16.0);
addControl.frame = CGRectMake((bounds.size.width - size.width) / 2.0,bounds.size.height - bottomInset - size.height,size.width,size.height);
}
for (UIViewController *module in CCACollectModuleControllers(overlay)) {
...
CGRect borderFrame = borderHost ? [overlay.view convertRect:moduleFrame toView:borderHost] : CGRectMake(module.view.frame.origin.x,module.view.frame.origin.y,module.view.bounds.size.width,module.view.bounds.size.height);
...
- (void)editChromeDisplayLinkFired:(CADisplayLink *)displayLink {
if (!gEditModeActive) return;
for (UIViewController *overlay in gOverlayControllers.allObjects) {
...
CGFloat clamped = (1.0<(0.0>progress?1.0:MAX(0.0, progress?0.0:progress?1.0:MAX(0.0, progress));
[self updateEditControlFramesForOverlay:overlay];
UIButton *addControl = (UIButton *)[overlay.view viewWithTag:kCCAAddControlButtonTag];
NSMutableDictionary*pageGrids = getAss(overlay,kCCAEditPageGridsKey);
UIView *gridStack = getAss(overlay,kCCAEditGridStackKey);
...
UISearchBar *search = [[UISearchBar alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
search.tag = 11;
...
UIImage *fieldImage = [fieldRenderer imageWithActions:^(UIGraphicsImageRendererContext *context) {
...
UIScrollView *scroll = [[UIScrollView alloc] initWithFrame:((CGRect){{0,0},{0,0}})];
scroll.tag = 12;
...
search.frame = CGRectMake(12.0,18.0,bounds.size.width - 24.0,54.0);
scroll.frame = CGRectMake(0.0,82.0,bounds.size.width,bounds.size.height - 82.0);
if (!self.builtGrid && bounds.size.width > 1.0) {
self.builtGrid = YES;
[self reloadGrid];
}
}
...
if (!query.length) {
NSArray*priority = @[@"flashlightmodule", @"controlcenter.timer", @"alarmmodule", @"calculatormodule", @"cameramodule", @"appearancemodule", @"qrcodemodule", @"magnifiermodule", @"lowpowermodule", @"hearingdevices", @"controlcenter.screencapture", @"nfccontrolcenter"];
NSMutableArray *suggested = [NSMutableArray array];
NSMutableSet*suggestedIdentifiers = [NSMutableSet set];
...
NSArray*suggestionCategories = @[@"Accessibility", @"Capture", @"Clock", @"Display", @"Focus", @"Home", @"Media", @"Notes", @"Voice Memos", @"Wallet", @"Utilities", @"Tweaks"];
...
NSArray*order = @[@"Accessibility", @"Capture", @"Clock", @"Connectivity", @"Display", @"Focus", @"Home", @"Media", @"Notes", @"Voice Memos", @"Wallet", @"Utilities", @"Tweaks"];
...
- (UIView *)previewForEntry:(NSDictionary *)entry usedIdentifiers:(NSMutableSet*)usedIdentifiers {
NSString *identifier = entry[@"identifier"];
...
CGFloat margin = (16.0>(width - contentWidth?16.0:(width - contentWidth) / 2.0);
CGFloat labelBand = 38.0;
CGFloat y = 6.0;
NSMutableSet*usedIdentifiers = [NSMutableSet set];
...
header.text = title;
header.font = [UIFont systemFontOfSize:13.0 weight:2];
...
NSUInteger columns = (1>(4<(NSUInteger?4:(NSUInteger?1:(4<(NSUInteger?4:(NSUInteger)llround((size.width + gap) / kCCAGridStep)));
NSUInteger rows = (1>(4<(NSUInteger?4:(NSUInteger?1:(4<(NSUInteger?4:(NSUInteger)llround((size.height + gap) / kCCAGridStep)));
...
NSMutableArray*> *occupancy = [NSMutableArray array];
...
preview.frame = (CGRect){((CGPoint){0,0}), size};
[cell addSubview:preview];
if ([entry[@"allowsMultiple"] boolValue] && [entry[@"instanceCount"] unsignedIntegerValue] > 0) {
UILabel *badge = [[UILabel alloc] initWithFrame:CGRectMake(preview.bounds.size.width - 24.0,-7.0,31.0,23.0)];
...
objc_setAssociatedObject(cell, @selector(cellTapped:), entry[@"identifier"], 3);
[container addSubview:cell];
sectionBottom = (sectionBottom>itemY + cellHeight?sectionBottom:itemY + cellHeight);
}
y = sectionBottom + 20.0;
}
container.frame = CGRectMake(0.0,0.0,width,y);
scroll.contentSize = CGSizeMake(width,y + 44.0);
if (self.query.length && scroll.contentOffset.y > 0.0) [scroll setContentOffset:((CGPoint){0,0}) animated:NO];
}
...
if (!identifier.length) return;
[UIView animateWithDuration:0.10 animations:^{ gesture.view.transform = CGAffineTransformMakeScale(0.94, 0.94); } completion:^(BOOL finished) {
...
NSArray*custom = gCCACustomSizes[identifier];
...
@try{ containers = [(id)self valueForKey:@"moduleContainerViewByIdentifier"]; }@catch(id e){}
...
gCCANativeLayoutRects[identifier] = [NSValue value:&rect withObjCType:@encode(CCUILayoutRect)];
NSArray*customOrigin = gCCACustomOrigins[identifier];
...
BOOL fullScreen = (view.bounds.size.width - screenSize.width<0?-(view.bounds.size.width - screenSize.width):view.bounds.size.width - screenSize.width) < 8.0 &&
(view.bounds.size.height - screenSize.height<0?-(view.bounds.size.height - screenSize.height):view.bounds.size.height - screenSize.height) < 8.0;
...
id result = %orig;
@try{ CCAApplyCompactGridSpacingToLayoutOptions([(id)result valueForKey:@"layoutOptions"]); }@catch(id e){}
return result;
}
- (void)layoutSubviews {
%orig;
...
scrollView.showsHorizontalScrollIndicator = NO;
scrollView.scrollIndicatorInsets = ((UIEdgeInsets){0,0,0,0});
if ((scrollView.contentOffset.x<0?-(scrollView.contentOffset.x):scrollView.contentOffset.x) > 0.25 || (scrollView.contentOffset.y<0?-(scrollView.contentOffset.y):scrollView.contentOffset.y) > 0.25) {
...
CGRect frame = %orig;
if (gEnabled) {
CGFloat containerWidth = ((UIView *.size.width(id)self).window.bounds);
if (containerWidth < 1.0) containerWidth = UIScreen.mainScreen.bounds.size.width;
...
%end
static NSArray*CCAResizedPreviewSizeForDescendant(UIView *view) {
for (UIView *ancestor = view; ancestor; ancestor = ancestor.superview) {
NSArray*size = getAss(ancestor,kCCAResizePresentationSizeOverrideKey);
...
}@catch(id e){ view.layer.filters = nil; }
}
view.layer.opacity = 1.0;
CABasicAnimation *fade = [CABasicAnimation animationWithKeyPath:@"opacity"];
fade.fromValue = @0.18;
...
@try{ mediaExpanding = [[container valueForKey:@"_expanded"] boolValue]; }@catch(id e){}
}
if (mediaExpanding) return 0;
}
UIView *npView = CCAMediaAncestorOfClass(view, @"MRUNowPlayingView");
if (npView) {
@try{
NSInteger layout = [[npView valueForKey:@"_layout"] integerValue];
if (layout == 1 || layout == 2) return 0;
}@catch(id e){}
}
return 1;
}
static NSString *CCAMediaModeForNowPlayingView(UIView *npView) {
NSArray*preview = CCAResizedPreviewSizeForDescendant(npView);
...
NSString *stored = getAss(npView,kCCANowPlayingLayoutModeKey);
...
label.font = [UIFont systemFontOfSize:13.0 weight:isTitle ? 2 : UIFontWeightRegular];
...
if (getAss(nowPlayingView,kCCANowPlayingLayoutModeKey)) {
setAss(nowPlayingView,kCCANowPlayingLayoutModeKey, nil, 3);
...
NSString *previous = getAss(nowPlayingView,kCCANowPlayingLayoutModeKey);
setAss(nowPlayingView,kCCANowPlayingLayoutModeKey, mode, 3);
UIView *artwork = CCAIvarView(nowPlayingView, "_artworkView");
UIView *header = CCAIvarView(nowPlayingView, "_headerView");
UIView *time = CCAIvarView(nowPlayingView, "_timeControlsView");
UIView *transport = CCAIvarView(nowPlayingView, "_transportControlsView");
...
CGFloat W = nowPlayingView.bounds.size.width;
[UIView performWithoutAnimation:^{
...
CGRect artworkFrame, transportFrame, timeFrame = ((CGRect){{0,0},{0,0}}), volumeFrame = ((CGRect){{0,0},{0,0}});
if (wide1) {
...
artwork.layer.cornerRadius = artworkFrame.size.width * 0.22;
...
UIViewController *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([[candidate.class className] isEqualToString:className]) return candidate;
[queue addObjectsFromArray:candidate.childViewControllers];
}
return nil;
}
...
if ([[presentedRoot.class className] isEqualToString:@"CCUIConnectivityModuleViewController"]) presentedConnectivity = presentedRoot;
...
setAss(roundButton,kCCAConnectivityExpandedCardKey, nil, 0);
setAss(roundButton,kCCAConnectivityExpandedSurfaceKey, nil, 0);
setAss(roundButton,kCCAConnectivityExpandedGridGlyphKey, nil, 1);
...
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
if ([getAss(candidate,kCCAConnectivitySuppressedSurfaceKey) boolValue]) {
setAss(candidate,kCCAConnectivitySuppressedSurfaceKey, nil, 1);
candidate.hidden = NO;
candidate.alpha = 1.0;
candidate.layer.opacity = 1.0;
}
...
if (![getAss(child,kCCAConnectivityProxyPreparedKey) boolValue]) {
[child beginAppearanceTransition:YES animated:NO];
[child endAppearanceTransition];
setAss(child,kCCAConnectivityProxyPreparedKey, @YES, 1);
}
...
BOOL drawn = [roundButton drawViewHierarchyInRect:(CGRect){((CGPoint){0,0}), sourceSize} afterScreenUpdates:YES];
...
UIView *roundButton = CCAFindSubviewWithClassName(child.view, @"CCUIRoundButton");
if ([roundButton isKindOfClass:[UIControl class]]) setAss(proxy,kCCAConnectivityForwardControlKey, roundButton, 0);
proxy.frame = frame;
proxy.hidden = NO;
proxy.clipsToBounds = NO;
...
BOOL receiving = mode.length && [mode rangeOfString:@"Off" options:NSCaseInsensitiveSearch].location == NSIntegerMax;
...
proxy.layer.cornerRadius = frame.size.height * 0.5;
proxy.layer.cornerCurve = kCACornerCurveContinuous;
proxy.layer.masksToBounds = YES;
}
...
if (tag == kCCAConnectivityCompactAirDropTag) {
UIView *roundButton = CCAFindSubviewWithClassName(child.view, @"CCUIRoundButton");
NSMutableArray*queue = roundButton ? [NSMutableArray arrayWithObject:roundButton] : [NSMutableArray array];
UIImage *glyph = nil;
...
CGFloat side = (bounds.size.width<bounds.size.height?bounds.size.width:bounds.size.height);
CGFloat inset = (6.0>round(side * 0.103?6.0:round(side * 0.103));
CGFloat gap = (4.0>round(side * 0.055?4.0:round(side * 0.055));
CGFloat cell = floor((side - inset * 2.0 - gap) * 0.5);
CGFloat originX = round((bounds.size.width - (cell * 2.0 + gap)) * 0.5);
CGFloat originY = round((bounds.size.height - (cell * 2.0 + gap)) * 0.5);
...
CGFloat inset = (12.0>round(width * 0.05?12.0:round(width * 0.05));
CGFloat gap = (8.0>round(width * 0.031?8.0:round(width * 0.031));
CGFloat contentWidth = (1.0>width - inset * 2.0?1.0:width - inset * 2.0);
CGFloat square = floor((contentWidth - gap) * 0.5);
CGFloat barHeight = (52.0>round(square * 0.445?52.0:round(square * 0.445));
...
while (container && ![[container.class className] isEqualToString:@"CCUIContentModuleContentContainerView"]) {
...
[[candidate.class className] isEqualToString:@"MTMaterialView"]) {
return candidate;
}
...
@try{ material = [source copy]; }@catch(id e){}
}
...
UIView *roundButton = CCAFindSubviewWithClassName(child.view, @"CCUIRoundButton");
BOOL wide = frame.size.height < frame.size.width * 0.7;
CGFloat iconSide = 38.0;
CGFloat iconInset = wide ? round((frame.size.height - iconSide) * 0.5) : 16.0;
if (labeled != child.view) labeled.frame = child.view.bounds;
if (roundButton) {
roundButton.frame = CGRectMake(iconInset,iconInset,iconSide,iconSide);
setAss(roundButton,kCCAConnectivityExpandedCardKey, card, 0);
setAss(roundButton,kCCAConnectivityExpandedSurfaceKey, child.view, 0);
setAss(roundButton,kCCAConnectivityExpandedGridGlyphKey,
wide ? nil : @YES, 1);
...
setAss(labeled,kCCAConnectivityExpandedCardKey, card, 0);
...
NSMutableArray*queue = [NSMutableArray arrayWithObject:labeled];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
...
CGFloat groupTop = round((frame.size.height - lineHeight * 2.0) * 0.5);
if (title) {
title.textAlignment = NSTextAlignmentLeft;
title.frame = CGRectMake(labelX,groupTop,frame.size.width - labelX - iconInset,lineHeight);
}
if (subtitle) {
subtitle.textAlignment = NSTextAlignmentLeft;
subtitle.frame = CGRectMake(labelX,groupTop + lineHeight,frame.size.width - labelX - iconInset,lineHeight);
}
return;
}
if (!title) return;
CGFloat textX = 21.0;
CGFloat textWidth = (0.0>frame.size.width - textX - 24.0?0.0:frame.size.width - textX - 24.0);
CGFloat lineHeight = 14.3333;
title.font = [UIFont systemFontOfSize:11.0 weight:2];
title.numberOfLines = 2;
title.lineBreakMode = NSLineBreakByTruncatingTail;
...
CGFloat groupTop = frame.size.height - 17.3333 - groupHeight;
title.frame = CGRectMake(textX,groupTop,textWidth,titleHeight);
...
BOOL compact = root.bounds.size.width < 190.0 && root.bounds.size.height < 190.0;
...
BOOL expanded = gCCAExpandedModuleOpen && root.bounds.size.width > 250.0 && root.bounds.size.height > 300.0;
...
scroll.contentSize = CGSizeMake(width,(root.bounds.size.height>metrics.contentHeight?root.bounds.size.height:metrics.contentHeight));
[cardOrder enumerateObjectsUsingBlock:^(NSString *name, NSUInteger index, BOOL *stop) {
...
card.hidden = NO;
card.frame = frame;
BOOL squareCard = (frame.size.width - frame.size.height<0?-(frame.size.width - frame.size.height):frame.size.width - frame.size.height) < 2.0;
card.layer.cornerRadius = squareCard ? (26.0<round(frame.size.width * 0.17?26.0:round(frame.size.width * 0.17))
: (22.0<round(frame.size.height * 0.38?22.0:round(frame.size.height * 0.38));
...
CGRect vpnFrame = CGRectMake(metrics.inset,(hotspotFrame.origin.y+hotspotFrame.size.height) + metrics.gap,width - metrics.inset * 2.0,metrics.barHeight);
if (!vpn) {
...
UILabel *title = [[UILabel alloc] initWithFrame:CGRectMake(labelX,labelTop,vpnFrame.size.width - labelX - iconInset,17.0)];
title.text = @"VPN"; title.font = [UIFont systemFontOfSize:13.0 weight:2]; title.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.58];
[vpn addSubview:title];
UILabel *status = [[UILabel alloc] initWithFrame:CGRectMake(labelX,labelTop + 17.0,vpnFrame.size.width - labelX - iconInset,17.0)];
...
[UIView performWithoutAnimation:^{
[largeFrames enumerateKeysAndObjectsUsingBlock:^(NSString *name, NSValue *frameValue, BOOL *stop) {
...
CGFloat requestedMiniGap = (2.0>naturalMiniGap - 3.0?2.0:naturalMiniGap - 3.0);
...
NSArray*symbols = @[@"antenna.radiowaves.left.and.right", @"bluetooth", @"personalhotspot", @"network"];
NSArray*colors = @[
...
[miniCluster.subviews enumerateObjectsUsingBlock:^(UIView *tile, NSUInteger index, BOOL *stop) {
CGFloat x = (index % 2) * (miniCell + miniGap), y = (index / 2) * (miniCell + miniGap);
...
CGRect bluetoothFrame = CGRectMake(compactMetrics.bottomRight.origin.x + miniCell + miniGap,compactMetrics.bottomRight.origin.y,miniCell,miniCell);
...
if (![getAss(controller,kCCAConnectivityProxyRefreshScheduledKey) boolValue]) {
setAss(controller,kCCAConnectivityProxyRefreshScheduledKey, @YES, 1);
...
if (![[parent.class className] isEqualToString:@"CCUIConnectivityModuleViewController"] || parent.view.bounds.size.width < 250.0) return;
CGRect frame = CCAExpandedConnectivityFrameForClass([child.class className], parent.view.bounds.size);
...
NSUInteger index = [order indexOfObject:[child.class className]];
UIView *card = index == NSIntegerMax ? nil : [parent.view viewWithTag:kCCAConnectivityExpandedCardBaseTag + (NSInteger)index];
CCAStyleExpandedConnectivityChild(child, card, frame);
}];
}
...
setAss(routing,kCCAMediaRouteGlyphShrinkKey, @YES, 1);
...
placeholderView.frame = CGRectMake(0.0,(view.bounds.size.height - 18.0) / 2.0,view.bounds.size.width,18.0);
...
CGFloat startY = (0.0>(view.bounds.size.height - totalHeight?0.0:(view.bounds.size.height - totalHeight) / 2.0);
...
- (void)layoutSubviews {
%orig;
if (![getAss(self,kCCAMediaRouteGlyphShrinkKey) boolValue]) return;
UIView *view = (UIView *)(id)self;
if (!CCAActiveMediaMode(view)) return;
[UIView performWithoutAnimation:^{
...
CGFloat W = view.bounds.size.width;
CGFloat centerY = view.bounds.size.height / 2.0;
[UIView performWithoutAnimation:^{
...
CGFloat width = ((UIViewController *.size.width(id)self).view.bounds);
...
if (width < 250.0) width = UIScreen.mainScreen.bounds.size.width * 0.856;
...
static void*kConnectivityDeferredLayout=&kConnectivityDeferredLayout;
BOOL compact = controller.view.bounds.size.width < 190.0 && controller.view.bounds.size.height < 190.0 && !gCCAExpandedModuleOpen;
if (compact && ![getAss(controller,kCCAConnectivityDeferredLayoutKey) boolValue]) {
setAss(controller,kCCAConnectivityDeferredLayoutKey, @YES, 1);
__weak UIViewController *weakController = controller;
dispatch_async(dispatch_get_main_queue(), ^{
UIViewController *strongController = weakController;
if (!strongController) return;
setAss(strongController,kCCAConnectivityDeferredLayoutKey, nil, 1);
CCAConfigureConnectivityLayout(strongController);
});
}
}
...
if (gEnabled && (gEditModeActive || gCCAEditTransitionActive)) return 0;
...
CGFloat width = connectivity.view.bounds.size.width;
SEL widthSelector = NSSelectorFromString(@"preferredExpandedContentWidth");
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
UIView *view = (UIView *)(id)self;
if (gEnabled && gCCAExpandedModuleOpen && getAss(view,kCCAConnectivityExpandedCardKey) &&
...
![getAss(button,kCCAConnectivityExpandedGridGlyphKey) boolValue]) return;
[CATransaction begin];
[CATransaction setDisableActions:YES];
...
%orig;
UIView *button = (UIView *)(id)self;
UIView *card = getAss(button,kCCAConnectivityExpandedCardKey);
UIView *surface = getAss(button,kCCAConnectivityExpandedSurfaceKey);
...
while (buttonView && ![[buttonView.class className] isEqualToString:@"CCUIButtonModuleView"]) buttonView = buttonView.superview;
BOOL keepsLeadingAnchor = [buttonView viewWithTag:kCCAResizePresentationTag] || [getAss(buttonView,kCCAResizePreviewKey) boolValue];
if (!buttonView || !keepsLeadingAnchor) return;
if (packageView.bounds.size.width <= 80.0 && packageView.bounds.size.height <= 80.0 && packageView.superview) {
[UIView performWithoutAnimation:^{
[CATransaction begin];
[CATransaction setDisableActions:YES];
if (gCCAResizeInProgress) {
...
if (content.bounds.size.width <= 60.0 && content.bounds.size.height <= 60.0) {
[UIView performWithoutAnimation:^{
[CATransaction begin];
[CATransaction setDisableActions:YES];
if (gCCAResizeInProgress) {
...
for (NSUInteger index = 0; index < (identifiers.count<sizes.count?identifiers.count:sizes.count); index++) sizeMap[identifiers[index]] = sizes[index];
...
if (CACurrentMediaTime() < gCCAEditExitConsumedUntil) return 1;
}
return %orig;
}
...
CGFloat clamped = (1.0<(0.0>(CGFloat?1.0:MAX(0.0, (CGFloat?0.0:(CGFloat?1.0:MAX(0.0, (CGFloat)progress));
if (overlay && CCAInteractivePagingGeometryActive()) {
[[CCAsterCoordinator shared] applyPageTransformToOverlay:overlay animated:NO];
}
...
[host.layer removeAllAnimations];
setAss(host,kCCAQuickAccessAnimationTokenKey, [NSObject new], 1);
...
if (state == 0) {
[UIView animateWithDuration:0.16 delay:0.0 options:UIViewAnimationOptionCurveEaseOut | 4<<16 animations:^{
...
CGPoint compactCenter = CGPointMake(CGRectGetMidX(gCCAExpansionCompactDestinationWindowFrame),CGRectGetMidY(gCCAExpansionCompactDestinationWindowFrame));
...
if ([[controller.class className] isEqualToString:@"CCUIConnectivityModuleViewController"]) return 1;
UIViewController *connectivity = CCAConnectivityChild(controller, @"CCUIConnectivityModuleViewController");
...
BOOL platterSized = (converted.size.width - presentedView.bounds.size.width<0?-(converted.size.width - presentedView.bounds.size.width):converted.size.width - presentedView.bounds.size.width) <= 8.0 &&
(converted.size.height - presentedView.bounds.size.height<0?-(converted.size.height - presentedView.bounds.size.height):converted.size.height - presentedView.bounds.size.height) <= 8.0;
BOOL belongsToCustomContent = candidate == contentView || [candidate isDescendantOfView:contentView];
if (effectSurface && platterSized && !belongsToCustomContent && !getAss(candidate,kCCAConnectivitySuppressedSurfaceKey)) {
setAss(candidate,kCCAConnectivitySuppressedSurfaceKey, @YES, 1);
candidate.alpha = 0.0;
}
[queue addObjectsFromArray:candidate.subviews];
}
...
tag == kCCAConnectivityExpandedVPNTag) return 1;
}
return 0;
}
static void CCASuppressConnectivityStockContainerMaterial(UIView *contentContainer) {
if (!contentContainer) return;
CGFloat containerWidth = contentContainer.bounds.size.width;
CGFloat containerHeight = contentContainer.bounds.size.height;
if (containerWidth < 1.0 || containerHeight < 1.0) return;
NSMutableArray*queue = [NSMutableArray arrayWithArray:contentContainer.subviews];
while (queue.count) {
UIView *candidate = queue.firstObject;
[queue removeObjectAtIndex:0];
NSString *name = [candidate.class className];
...
BOOL outerBacking = frame.size.width >= containerWidth * 0.68 &&
frame.size.height >= containerHeight * 0.68;
if (outerBacking) {
setAss(candidate,kCCAConnectivitySuppressedSurfaceKey, @YES, 1);
[candidate.layer removeAllAnimations];
candidate.hidden = YES;
...
CGFloat width = contentContainer.bounds.size.width;
if (width < 250.0) width = contentContainer.frame.size.width;
if (width < 250.0) return;
CCAConnectivityExpandedMetrics metrics = CCAConnectivityMetricsForWidth(width);
UIEdgeInsets safeInsets = presentedRoot.window.safeAreaInsets;
CGFloat availableHeight = presentedRoot.bounds.size.height - safeInsets.top - safeInsets.bottom - 32.0;
CGFloat height = (metrics.contentHeight<availableHeight?metrics.contentHeight:availableHeight);
...
frame.size = CGSizeMake(width,height);
frame.origin.x = round((presentedRoot.bounds.size.width - width) * 0.5);
frame.origin.y = round((presentedRoot.bounds.size.height - height) * 0.5);
...
if ([[presentationController.presentedViewController.class className] isEqualToString:@"CCUIConnectivityModuleViewController"]) {
...
UIImage *image = [renderer imageWithActions:^(UIGraphicsImageRendererContext *context) {
BOOL drawn = [view drawViewHierarchyInRect:(CGRect){((CGPoint){0,0}), view.bounds.size}
...
if (index == NSIntegerMax || index > superview.subviews.count) index = superview.subviews.count;
...
gCCAConnectivityDetachedOriginalFrame = ((CGRect){{0,0},{0,0}});
gCCAConnectivityDetachedOriginalBounds = ((CGRect){{0,0},{0,0}});
gCCAConnectivityDetachedOriginalIndex = NSIntegerMax;
}
...
gCCAConnectivityTransitionWindow.windowLevel = (gCCAConnectivityTransitionWindow.windowLevel>window.windowLevel + 100.0?gCCAConnectivityTransitionWindow.windowLevel:window.windowLevel + 100.0);
...
transitionWindow.windowLevel = (UIWindowLevelAlert + 100.0>window.windowLevel + 100.0?UIWindowLevelAlert + 100.0:window.windowLevel + 100.0);
...
if (!window || window.bounds.size.width < 1.0 || window.bounds.size.height < 1.0) return nil;
UIGraphicsImageRendererFormat *format = [UIGraphicsImageRendererFormat defaultFormat];
format.opaque = NO;
format.scale = UIScreen.mainScreen.scale;
...
CGContextSaveGState(context.CGContext);
CGContextTranslateCTM(context.CGContext, -window.bounds.origin.x, -window.bounds.origin.y);
...
if (!image.CGImage || rect.size.width < 1.0 || rect.size.height < 1.0) return nil;
CGFloat scale = image.scale;
CGRect pixels = CGRectMake(round(rect.origin.x * scale),round(rect.origin.y * scale),round(rect.size.width * scale),round(rect.size.height * scale));
...
if (CGRectIsNull(pixels) || pixels.size.width < 1.0 || pixels.size.height < 1.0) return nil;
...
NSMutableArray*screenFrames = [NSMutableArray arrayWithCapacity:cards.count];
...
[cards enumerateObjectsUsingBlock:^(UIView *card, NSUInteger index, BOOL *stop) {
...
if (!cardImage) return;
CGRect relativeFrame = CGRectOffset(screenFrame, -unionScreenFrame.origin.x, -unionScreenFrame.origin.y);
...
return (0.46<(0.30>duration?0.46:MAX(0.30, duration?0.30:duration?0.46:MAX(0.30, duration));
}
...
static void CCABeginConnectivityOpeningTransition(UIViewController *controller) {
if (!controller.view.window || controller.view.bounds.size.width < 1.0) return;
...
gCCAConnectivityHasCompactWindowFrame = frame.size.width > 1.0 && frame.size.height > 1.0;
...
if ([[presented.class className] isEqualToString:@"CCUIConnectivityModuleViewController"]) controller = presented;
...
CGRect finalScreenFrame = CGRectMake(round((screenBounds.size.width - finalSize.width) * 0.5),round((screenBounds.size.height - finalSize.height) * 0.5),finalSize.width,finalSize.height);
...
NSTimeInterval duration = (0.70<(0.64>CCAConnectivityTransitionDuration(presented?0.70:MAX(0.64, CCAConnectivityTransitionDuration(presented?0.64:CCAConnectivityTransitionDuration(presented?0.70:MAX(0.64, CCAConnectivityTransitionDuration(presented) + 0.24));
[UIView animateKeyframesWithDuration:duration delay:0.0
options:UIViewKeyframeAnimationOptionCalculationModeCubic | 0<<16 |
4<<16
animations:^{
...
NSTimeInterval duration = (0.62<(0.56>CCAConnectivityTransitionDuration(presented?0.62:MAX(0.56, CCAConnectivityTransitionDuration(presented?0.56:CCAConnectivityTransitionDuration(presented?0.62:MAX(0.56, CCAConnectivityTransitionDuration(presented) + 0.18));
...
options:UIViewAnimationOptionCurveEaseOut | 4<<16
...
@try{ anchor = [(id)presentationController valueForKey:@"anchoringViewController"]; }@catch(id e){}
if (!anchor) {
@try{ anchor = [(id)presentationController valueForKey:@"_anchoringViewController"]; }@catch(id e){}
}
CGFloat radius = 0.0;
...
BOOL fillsContent = (candidate.bounds.size.width - contentView.bounds.size.width<0?-(candidate.bounds.size.width - contentView.bounds.size.width):candidate.bounds.size.width - contentView.bounds.size.width) < 4.0 &&
(candidate.bounds.size.height - contentView.bounds.size.height<0?-(candidate.bounds.size.height - contentView.bounds.size.height):candidate.bounds.size.height - contentView.bounds.size.height) < 4.0;
...
if (width < 100.0) width = UIScreen.mainScreen.bounds.size.width * 0.856;
CCAConnectivityExpandedMetrics metrics = CCAConnectivityMetricsForWidth(width);
UIEdgeInsets safeInsets = viewController.view.window.safeAreaInsets;
CGFloat availableHeight = UIScreen.mainScreen.bounds.size.height - safeInsets.top - safeInsets.bottom - 48.0;
return (metrics.contentHeight<availableHeight?metrics.contentHeight:availableHeight);
}
...
if ([[presentation.presentedViewController.class className] isEqualToString:@"CCUIConnectivityModuleViewController"]) {
...
BOOL sourceIsMedia = [[[sourceObject class] className] isEqualToString:@"MediaControlsModule"];
if (identifier.length &&
...
gCCAMediaCompactDestinationScreenFrame = ((CGRect){{0,0},{0,0}});
gCCAMediaExpandedPresentationScreenFrame = ((CGRect){{0,0},{0,0}});
...
gCCAMediaTransitionWindow.windowLevel = (gCCAMediaTransitionWindow.windowLevel>sourceWindow.windowLevel + 100.0?gCCAMediaTransitionWindow.windowLevel:sourceWindow.windowLevel + 100.0);
...
window.windowLevel = (UIWindowLevelAlert + 100.0>sourceWindow.windowLevel + 100.0?UIWindowLevelAlert + 100.0:sourceWindow.windowLevel + 100.0);
UIViewController *root = [UIViewController new];
...
if (!window || (view.bounds.size.width<=0||view.bounds.size.height<=0)) return nil;
...
static UIView *CCAWindowCropSnapshotForWindowRect(UIWindow *window, CGRect crop) {
if (!window || (crop.size.width<=0||crop.size.height<=0)) return nil;
...
withCapInsets:((UIEdgeInsets){0,0,0,0})];
}
if (!snapshot) return;
snapshot.userInteractionEnabled = NO;
snapshot.layer.cornerRadius = compactSurface.layer.cornerRadius;
...
if (!(currentDestinationScreenFrame.size.width<=0||currentDestinationScreenFrame.size.height<=0)) {
...
if (!mediaController && [[module.class className] isEqualToString:@"MRUControlCenterViewController"]) {
...
if ([[expandedController.class className] isEqualToString:@"CCUIConnectivityModuleViewController"]) connectivity = expandedController;
...
[[[module class] className] isEqualToString:@"MediaControlsModule"];
if (openingMedia) {
...
[openingIdentifier rangeOfString:@"Connectivity" options:NSCaseInsensitiveSearch].location != NSIntegerMax);
...
if (expandedWidth < 250.0) expandedWidth = UIScreen.mainScreen.bounds.size.width * 0.856;
...
CGFloat width = presented.view.bounds.size.width;
if (width < 250.0) width = UIScreen.mainScreen.bounds.size.width * 0.856;
...
UIView *pageIndicators = [overlay.view viewWithTag:kCCAPageIndicatorHostTag];
if (pageIndicators) {
setAss(pageIndicators,kCCAPageIndicatorDraggingKey, nil, 1);
BOOL revealActive = CCAExpandedChromeRevealActive();
...
BOOL closingMedia = [[[module class] className] isEqualToString:@"MediaControlsModule"] ||
...
%end
%end
static void CCAPrefsChanged(CFNotificationCenterRef center, void *observer, CFStringRef name, const void *object, CFDictionaryRef userInfo) {
CCALoadPrefs();
dispatch_async(dispatch_get_main_queue(), ^{
CCAsterCoordinator *coordinator = [CCAsterCoordinator shared];
